...
abstract interface class ClientStatementRepository {
...
class SpinaClientStatementRepository implements ClientStatementRepository {
  SpinaClientStatementRepository({http.Client? client})
  ...
  Future<ClientStatement> loadStatement(
    ...
    final endpoint = ApiConfig.endpoint('/api/mobile/v1/client/statement');
    ...
    try {
      ...
      throw const SpinaApiException(
        'Statement of Account could not reach the SPINA server.',
    ...
    try {
      ...
      throw SpinaApiException(
        'The SPINA server returned unreadable statement data.',
    ...
    if (response.statusCode >= 200 && response.statusCode < 300) {
      return ClientStatement.fromPayload(
