...
abstract interface class ClientPaymentRepository {
...
class SpinaClientPaymentRepository implements ClientPaymentRepository {
  SpinaClientPaymentRepository({http.Client? client})
  ...
  Future<ClientPaymentTimeline> loadTimeline(
    ...
    final endpoint = ApiConfig.endpoint('/api/mobile/v1/client/payments');
    ...
    try {
      ...
      throw const SpinaApiException(
        'Payments could not reach the SPINA server.',
    ...
    try {
      ...
      throw SpinaApiException(
        'The SPINA server returned unreadable payment data.',
    ...
    if (response.statusCode >= 200 && response.statusCode < 300) {
      return ClientPaymentTimeline.fromPayload(
        stringMap(
