...
abstract interface class ClientScheduleRepository {
...
class SpinaClientScheduleRepository implements ClientScheduleRepository {
  SpinaClientScheduleRepository({http.Client? client})
  ...
  Future<ClientLoanSchedule> loadSchedule(
    ...
    final endpoint = ApiConfig.endpoint(
      '/api/mobile/v1/client/loans/$encodedLoanId/schedule',
    );
    ...
    try {
      ...
      throw const SpinaApiException(
        'Payment schedule could not reach the SPINA server.',
    ...
    if (response.statusCode >= 200 && response.statusCode < 300) {
      return ClientLoanSchedule.fromPayload(
        stringMap(
