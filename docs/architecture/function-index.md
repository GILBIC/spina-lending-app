...
Generated from commit `fd471dabf3bad1cd324901da7c0f9f6381406f36`.

Scanned **270 Python files**, **84,844 lines**, and **2,795 symbols**.
...
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App** (class, lines 7061–10283, 3223 lines, risk `container`): Groups App for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._mode_filter** (method, lines 7064–7072, 9 lines, risk `filesystem`): Return loan_type filter value for DB queries (Regular / 7x7).
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._on_mode_change** (method, lines 7074–7096, 23 lines, risk `reports`): Refresh visible tables when the mode selector changes.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._access_prefs_path** (method, lines 7105–7108, 4 lines, risk `support`): Handles access prefs path for the authentication feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._load_user_role** (method, lines 7110–7122, 13 lines, risk `authentication`): Best-effort load of last used role. Not security—just convenience.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._save_user_role** (method, lines 7124–7152, 29 lines, risk `authentication`): Saves save user role for the authentication feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._users_db_path** (method, lines 7155–7158, 4 lines, risk `authentication`): Handles users db path for the authentication feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._hash_password_legacy** (method, lines 7159–7165, 7 lines, risk `authentication`): Handles hash password legacy for the payments feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._hash_password** (method, lines 7167–7203, 37 lines, risk `authentication`): Hash passwords using PBKDF2-HMAC-SHA256 by default. Legacy scheme supported for backward compatibility: - scheme: 'sha256_salt' (or 'legacy') uses SHA-256(salt + password) Stored records should include: - scheme: 'pbkdf2_sha256' (recommended) or 'sha256_salt' - iterations: integer (PBKDF2 only)
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._make_salt** (method, lines 7205–7214, 10 lines, risk `support`): Handles make salt for the authentication feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._default_password_for** (method, lines 7216–7218, 3 lines, risk `authentication`): Handles default password for for the payments feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._is_default_password_rec** (method, lines 7220–7238, 19 lines, risk `authentication`): True if this user's stored hash matches the known default password.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._must_change_password** (method, lines 7240–7265, 26 lines, risk `authentication`): Enforce password change if account is still using the known defaults.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._set_user_password** (method, lines 7267–7293, 27 lines, risk `authentication`): Update password hash+salt for user and clear must_change_password.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._force_change_password_dialog** (method, lines 7295–7413, 119 lines, risk `authentication`): Modal dialog that forces a password change. Returns True if changed.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._force_change_password_dialog._save** (nested_function, lines 7339–7367, 29 lines, risk `authentication`): Handles save for the payments feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._force_change_password_dialog._cancel** (nested_function, lines 7369–7377, 9 lines, risk `support`): Handles cancel for the payments feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._force_change_password_dialog._on_enter** (nested_function, lines 7382–7383, 2 lines, risk `support`): Handles on enter for the payments feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._save_users_db** (method, lines 7415–7436, 22 lines, risk `authentication`): Saves save users db for the authentication feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._load_users_db** (method, lines 7438–7508, 71 lines, risk `authentication`): Load users database from data/users.json. If missing, create defaults. Default accounts (created only if missing): - admin / admin123 -> Admin - encoder / encoder123 -> Encoder - viewer / viewer123 -> Viewer - system / system123 -> System
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._verify_login** (method, lines 7510–7549, 40 lines, risk `authentication`): Handles verify login for the authentication feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._load_last_user** (method, lines 7551–7558, 8 lines, risk `filesystem`): Loads load last user for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._save_last_user** (method, lines 7560–7588, 29 lines, risk `filesystem`): Saves save last user for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._prompt_login** (method, lines 7590–7715, 126 lines, risk `authentication`): Login dialog: returns (username, role) or (None, None) if cancelled.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._prompt_login._ok** (nested_function, lines 7639–7671, 33 lines, risk `authentication`): Handles ok for the authentication feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._prompt_login._cancel** (nested_function, lines 7673–7679, 7 lines, risk `support`): Handles cancel for the authentication feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._prompt_login._on_enter** (nested_function, lines 7684–7685, 2 lines, risk `support`): Handles on enter for the authentication feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._prompt_user_role** (method, lines 7718–7800, 83 lines, risk `authentication`): Simple role selector shown at startup.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._prompt_user_role._ok** (nested_function, lines 7755–7765, 11 lines, risk `support`): Handles ok for the authentication feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._prompt_user_role._cancel** (nested_function, lines 7767–7773, 7 lines, risk `support`): Handles cancel for the authentication feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._remove_role_overlays** (method, lines 7802–7815, 14 lines, risk `support`): Removes remove role overlays for the authentication feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._restore_main_tabs** (method, lines 7818–7835, 18 lines, risk `backup`): Handles restore main tabs for the backup feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._make_import_only_overlay** (method, lines 7837–7855, 19 lines, risk `ui_only`): Overlay that blocks tab interaction, leaving only an Import button.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._make_close_only_overlay** (method, lines 7857–7875, 19 lines, risk `ui_only`): Overlay that blocks tab interaction, leaving only Daily Close / Variance access.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App.apply_role_access** (method, lines 7877–8013, 137 lines, risk `authentication`): Apply role-based UI restrictions.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._open_note_dialog** (method, lines 8018–8044, 27 lines, risk `reports`): Handles open note dialog for the notes feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._prompt_current_password** (method, lines 8060–8073, 14 lines, risk `authentication`): Handles prompt current password for the payments feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._show_conflicts** (method, lines 8086–8110, 25 lines, risk `support`): Show areas assigned to multiple collectors.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._show_unassigned_areas** (method, lines 8112–8139, 28 lines, risk `support`): Show areas not assigned to any collector (plus any unknown route areas).
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._show_no_area_clients** (method, lines 8141–8165, 25 lines, risk `database_read`): Show clients that still have blank area (needs assignment).
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._delete_selected_collector** (method, lines 8168–8234, 67 lines, risk `filesystem`): Removes delete selected collector for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._edit_selected_collector** (method, lines 8237–8328, 92 lines, risk `filesystem`): Handles edit selected collector for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._add_collector** (method, lines 8330–8382, 53 lines, risk `filesystem`): Handles add collector for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._audit_money_text** (method, lines 8403–8410, 8 lines, risk `support`): Handles audit money text for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._audit_parse_date_filters** (method, lines 8412–8440, 29 lines, risk `support`): Handles audit parse date filters for the utilities feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._audit_set_today** (method, lines 8442–8450, 9 lines, risk `support`): Handles audit set today for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._audit_set_last7** (method, lines 8452–8461, 10 lines, risk `support`): Handles audit set last7 for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._audit_set_all** (method, lines 8463–8469, 7 lines, risk `support`): Handles audit set all for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._audit_tree_factory** (method, lines 8471–8487, 17 lines, risk `ui_only`): Handles audit tree factory for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._audit_set_detail_text** (method, lines 8490–8497, 8 lines, risk `ui_only`): Handles audit set detail text for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._audit_show_selected** (method, lines 8499–8554, 56 lines, risk `financial_calculation`): Handles audit show selected for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App.__init__** (method, lines 8557–8717, 161 lines, risk `authentication`): Handles init for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._prepare_tk_shutdown** (method, lines 8721–8739, 19 lines, risk `support`): Cancel recurring Tk callbacks before the root interpreter is destroyed.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._destroy_root_safely** (method, lines 8741–8748, 8 lines, risk `support`): Finish pending ttk idle work, cancel timers, then destroy the root once.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._start_ui_queue_pump** (method, lines 8750–8790, 41 lines, risk `support`): Process UI-call requests from worker threads on the Tk main thread.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._start_ui_queue_pump._schedule_next** (nested_function, lines 8752–8763, 12 lines, risk `ui_only`): Handles schedule next for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._start_ui_queue_pump._pump** (nested_function, lines 8765–8788, 24 lines, risk `support`): Handles pump for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._ui_call** (method, lines 8792–8839, 48 lines, risk `support`): Call a UI function from any thread and wait for completion. - If called from the Tk main thread, runs immediately. - If called from a worker thread, marshals execution onto the Tk main thread. - Includes a timeout to avoid deadlocks when the UI is closing.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._ui_async** (method, lines 8841–8854, 14 lines, risk `ui_only`): Schedule a UI function to run on the Tk main thread (non-blocking).
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._patch_messagebox_threadsafe** (method, lines 8856–8899, 44 lines, risk `support`): Make tkinter.messagebox safe to call from worker threads.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._setup_style** (method, lines 8901–9037, 137 lines, risk `ui_only`): Centralized ttk styling. Goals: - cleaner spacing / typography - readable Treeviews - consistent Notebook tabs - best-effort HiDPI handling on Windows
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App.toggle_theme** (method, lines 9043–9048, 6 lines, risk `support`): Handles toggle theme for the settings feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App.set_theme** (method, lines 9050–9109, 60 lines, risk `ui_only`): Updates set theme for the settings feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._configure_tree_stripes** (method, lines 9115–9148, 34 lines, risk `ui_only`): Configure zebra striping tags on a ttk.Treeview based on current theme. Important: tag backgrounds override ttk style colors. Without this, Dark Mode can end up with light (white) row backgrounds + light foreground, which is hard to read.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._apply_tree_stripes_all** (method, lines 9150–9159, 10 lines, risk `ui_only`): Re-apply zebra striping for known Treeviews (called after theme switch).
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._mk_tk_entry** (method, lines 9163–9179, 17 lines, risk `ui_only`): Handles mk tk entry for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._find_postgres_exe** (method, lines 9184–9222, 39 lines, risk `filesystem`): Find pg_dump.exe / pg_restore.exe without requiring PostgreSQL bin in PATH.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._postgres_backup_dir** (method, lines 9224–9232, 9 lines, risk `backup`): Return/create the app backup folder.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._create_postgres_backup_file** (method, lines 9234–9317, 84 lines, risk `backup`): Create a full PostgreSQL backup using pg_dump custom format. The backup includes clients, payments, JSON rows, PDFs, and pictures because those are now stored in spina_db. Password is passed through PGPASSWORD, not printed on screen.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App.backup_postgres_database** (method, lines 9319–9387, 69 lines, risk `backup`): UI handler for the Backup button.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App.backup_postgres_database._success** (nested_function, lines 9343–9359, 17 lines, risk `support`): Handles success for the backup feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App.backup_postgres_database._error** (nested_function, lines 9361–9375, 15 lines, risk `support`): Handles error for the backup feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._postgres_cfg** (method, lines 9391–9403, 13 lines, risk `support`): Return PostgreSQL connection settings used by this test build.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._pg_env** (method, lines 9405–9413, 9 lines, risk `filesystem`): Handles pg env for the database feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._format_bytes** (method, lines 9415–9425, 11 lines, risk `support`): Handles format bytes for the utilities feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._list_postgres_backup_files** (method, lines 9427–9449, 23 lines, risk `backup`): Return backup files from the app backups folder, newest first.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._verify_postgres_backup_file** (method, lines 9451–9484, 34 lines, risk `backup`): Verify a PostgreSQL custom backup by reading its table of contents.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._run_pg_command** (method, lines 9486–9513, 28 lines, risk `support`): Run PostgreSQL command-line tools with hidden password.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._restore_backup_to_test_database** (method, lines 9515–9550, 36 lines, risk `backup`): Restore selected backup into spina_restore_test only; never overwrites live spina_db.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._restore_backup_to_test_database._check_cancel** (nested_function, lines 9537–9542, 6 lines, risk `support`): Handles check cancel for the backup feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._select_side_tab** (method, lines 9556–9569, 14 lines, risk `support`): Handles select side tab for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._tk_button_hover** (method, lines 9577–9588, 12 lines, risk `ui_only`): Small hover helper for plain tk buttons/labels.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._set_mode** (method, lines 9591–9613, 23 lines, risk `filesystem`): Fast switch between Regular and 7x7 from the modern segmented control.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._build_header** (method, lines 9618–9786, 169 lines, risk `authentication`): Modern top header: app identity + fast Regular/7x7 switch + app actions.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._refresh_user_header** (method, lines 9788–9798, 11 lines, risk `authentication`): Refreshes refresh user header for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App.switch_account** (method, lines 9800–9845, 46 lines, risk `authentication`): Handles switch account for the authentication feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App.refresh_reports** (method, lines 9862–9968, 107 lines, risk `reports`): Refreshes refresh reports for the reports feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App.refresh_reports._display_loan_type_label** (nested_function, lines 9889–9896, 8 lines, risk `support`): Handles display loan type label for the loans feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App.open_report_generation_log** (method, lines 9972–9993, 22 lines, risk `filesystem`): Open the global Generate Report log file/folder.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._get_report_note_text** (method, lines 9997–10008, 12 lines, risk `reports`): Retrieves get report note text for the reports feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._set_report_note_text** (method, lines 10010–10039, 30 lines, risk `reports`): Updates set report note text for the reports feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._save_dated_note_for_client** (method, lines 10041–10080, 40 lines, risk `reports`): Saves save dated note for client for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._auto_load_report_note** (method, lines 10083–10113, 31 lines, risk `reports`): Handles auto load report note for the reports feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._get_selected_report_client** (method, lines 10117–10125, 9 lines, risk `reports`): Retrieves get selected report client for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._save_report_note_for_client** (method, lines 10127–10165, 39 lines, risk `reports`): Saves save report note for client for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._load_report_note_for_client** (method, lines 10168–10197, 30 lines, risk `reports`): Loads load report note for client for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App._refresh_area_dropdowns** (method, lines 10213–10229, 17 lines, risk `ui_only`): Refresh any area dropdowns (best-effort).
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.App.set_area_for_selected_clients** (method, lines 10232–10283, 52 lines, risk `reports`): Set one area for all selected clients in the Clients tab (current mode only).
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._build_collectors_tab** (function, lines 10415–10761, 347 lines, risk `ui_only`): Collector's Route UI (organized + obvious selection + inline edit). Adds: - Obvious selection column (radio in single-select, checkbox in multi-select) - Per-row Actions column (View / Edit / Delete) - Multi-select bulk bar (Delete / Export / Clear) - Inline edit in the right-side panel (name + area
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._build_collectors_tab._set_sort** (nested_function, lines 10539–10549, 11 lines, risk `support`): Updates set sort for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._build_collectors_tab._popup** (nested_function, lines 10612–10627, 16 lines, risk `ui_only`): Handles popup for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._build_collectors_tab._on_search** (nested_function, lines 10743–10747, 5 lines, risk `support`): Handles on search for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._collectors_name_from_values** (function, lines 10765–10808, 44 lines, risk `ui_only`): Return the collector name from a Treeview row values tuple. Backwards compatible with older layouts: - Old layout: first value is the collector name. - New layout: first value is a select marker (radio/checkbox/bullet), second is the collector name.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._on_collectors_multi_toggle** (function, lines 10828–10850, 23 lines, risk `support`): Handles on collectors multi toggle for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._on_collectors_tree_click** (function, lines 10854–10945, 92 lines, risk `filesystem`): Handle clicks in Sel + Actions columns.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._collectors_delete_selected** (function, lines 10947–10998, 52 lines, risk `filesystem`): Handles collectors delete selected for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._collectors_export_selected** (function, lines 11000–11053, 54 lines, risk `filesystem`): Handles collectors export selected for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._collectors_save_inline_edit** (function, lines 11060–11169, 110 lines, risk `filesystem`): Save inline edits to collectors.json (atomic), then refresh UI.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._collectors_areas_drag_start** (function, lines 11177–11181, 5 lines, risk `support`): Handles collectors areas drag start for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._collectors_areas_drag_motion** (function, lines 11183–11201, 19 lines, risk `ui_only`): Handles collectors areas drag motion for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._collectors_areas_drag_end** (function, lines 11203–11268, 66 lines, risk `support`): Handles collectors areas drag end for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._collectors_areas_drag_end._on_collectors_tree_wheel** (nested_function, lines 11208–11223, 16 lines, risk `support`): Ensure mousewheel scroll works on Collector Route list.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._collectors_areas_drag_end._schedule_collectors_refresh** (nested_function, lines 11225–11242, 18 lines, risk `ui_only`): Debounce refresh_collectors while typing in Search.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._collectors_areas_drag_end._clear_collectors_search_filters** (nested_function, lines 11244–11268, 25 lines, risk `support`): Handles clear collectors search filters for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._on_collectors_select** (function, lines 11271–14275, 3005 lines, risk `ui_only`): Populate the right-side details panel for the selected collector.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._on_collectors_select._populate_collector_details** (nested_function, lines 11329–11428, 100 lines, risk `support`): Update the right panel: selected name, stats, areas tree, notes.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._on_collectors_select._save_selected_collector_notes** (nested_function, lines 11430–11458, 29 lines, risk `support`): Save Notes from the right panel to collectors.json (atomic).
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._on_collectors_select._save_collector_notes** (nested_function, lines 11460–11504, 45 lines, risk `filesystem`): Internal: update one collector's notes in collectors.json.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._on_collectors_select._refresh_collectors_table** (nested_function, lines 11506–11512, 7 lines, risk `support`): Backward-compatible alias for older code paths.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._on_collectors_select._add_collector_dialog** (nested_function, lines 11514–11558, 45 lines, risk `filesystem`): Legacy dialog-based add; now writes the SAME dict schema as the main Collectors tab.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._on_collectors_select._edit_collector_dialog** (nested_function, lines 11560–11635, 76 lines, risk `filesystem`): Legacy dialog-based edit; now edits the main collectors.json dict schema.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._on_collectors_select._delete_collector** (nested_function, lines 11637–11697, 61 lines, risk `filesystem`): Legacy delete; now deletes from the main collectors.json dict schema.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._on_collectors_select.print_collector_route_daily_ledger** (nested_function, lines 11699–11909, 211 lines, risk `filesystem`): Print the SELECTED collector's route using the same 3-column Daily Collection Ledger layout as `print_full_daily_ledger`, but ONLY for that collector's areas (no 'arrange all areas' step). - Uses selection() first (more reliable than focus()). - Reads collectors.json in multiple historical schemas. 
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._on_collectors_select.print_full_daily_ledger** (nested_function, lines 11911–14275, 2365 lines, risk `financial_calculation`): Print a 3-column DAILY COLLECTION LEDGER with a small UI to change: - Ledger Date - Paper size and orientation - Areas order (arrange ALL areas)
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._on_collectors_select.print_full_daily_ledger._fetch_clients_for** (nested_function, lines 11956–11963, 8 lines, risk `support`): Loads fetch clients for for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._on_collectors_select.print_full_daily_ledger._s** (nested_function, lines 11986–11986, 1 lines, risk `support`): Handles s for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._on_collectors_select.print_full_daily_ledger._options_dialog** (nested_function, lines 11991–12052, 62 lines, risk `ui_only`): Handles options dialog for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._on_collectors_select.print_full_daily_ledger._options_dialog._ok** (nested_function, lines 12030–12032, 3 lines, risk `support`): Handles ok for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._on_collectors_select.print_full_daily_ledger._options_dialog._cancel** (nested_function, lines 12033–12035, 3 lines, risk `support`): Handles cancel for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._on_collectors_select.print_full_daily_ledger._arrange_areas_dialog** (nested_function, lines 12055–12128, 74 lines, risk `reports`): Handles arrange areas dialog for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._on_collectors_select.print_full_daily_ledger._arrange_areas_dialog._move** (nested_function, lines 12088–12101, 14 lines, risk `ui_only`): Handles move for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._on_collectors_select.print_full_daily_ledger._arrange_areas_dialog._ok** (nested_function, lines 12110–12111, 2 lines, risk `support`): Handles ok for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._on_collectors_select.print_full_daily_ledger._arrange_areas_dialog._cancel** (nested_function, lines 12112–12113, 2 lines, risk `support`): Handles cancel for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._on_collectors_select.print_full_daily_ledger._wrap_text_to_width** (nested_function, lines 13137–13164, 28 lines, risk `support`): Handles wrap text to width for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._on_collectors_select.print_full_daily_ledger._wrap_text_to_width._fits** (nested_function, lines 13142–13142, 1 lines, risk `support`): Handles fits for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._on_collectors_select.print_full_daily_ledger._draw_page_number** (nested_function, lines 13166–13172, 7 lines, risk `support`): Handles draw page number for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._on_collectors_select.print_full_daily_ledger._draw_final_footer** (nested_function, lines 13174–13189, 16 lines, risk `support`): Handles draw final footer for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._on_collectors_select.print_full_daily_ledger._draw_global_header** (nested_function, lines 13190–13235, 46 lines, risk `support`): Handles draw global header for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._on_collectors_select.print_full_daily_ledger.new_page_headers** (nested_function, lines 13254–13284, 31 lines, risk `support`): Handles new page headers for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._on_collectors_select.print_full_daily_ledger.ensure_space** (nested_function, lines 13290–13308, 19 lines, risk `support`): Handles ensure space for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina__client_schedule_anchor** (function, lines 14286–14299, 14 lines, risk `support`): Handles spina client schedule anchor for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina__client_due_meta** (function, lines 14302–14366, 65 lines, risk `support`): Return (day_due_label, due_today_bool) using stored schedule fields when present.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.refresh_clients** (function, lines 14368–14630, 263 lines, risk `filesystem`): Refresh the Clients tab table from the database, honoring the search box.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.refresh_clients.delete_client_selected** (nested_function, lines 14466–14499, 34 lines, risk `reports`): Removes delete client selected for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.refresh_clients.renew_client_selected** (nested_function, lines 14502–14568, 67 lines, risk `financial_calculation`): Renew (reloan) the selected client and update the client row.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.refresh_clients.open_client_history_dialog** (nested_function, lines 14571–14581, 11 lines, risk `support`): Open the richer audit-style history dialog for the selected client.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.refresh_clients.add_client_dialog** (nested_function, lines 14584–14602, 19 lines, risk `reports`): Handles add client dialog for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.refresh_clients.on_client_edit** (nested_function, lines 14604–14630, 27 lines, risk `reports`): Handles on client edit for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._maybe_suggest_link_clients** (function, lines 14636–16623, 1988 lines, risk `filesystem`): Auto-suggest linking when a matching client exists in the other loan type. - YES links both rows (same person_uid). - NO sets link_opt_out=1 for BOTH rows so you won't be asked again from either side, unless you manually link later.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._maybe_suggest_link_clients.link_selected_client** (nested_function, lines 14724–14847, 124 lines, risk `ui_only`): Manually link the selected client to another loan type record.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._maybe_suggest_link_clients.link_selected_client.do_link** (nested_function, lines 14791–14835, 45 lines, risk `support`): Handles do link for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._maybe_suggest_link_clients.link_selected_client.cancel** (nested_function, lines 14837–14838, 2 lines, risk `support`): Handles cancel for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._maybe_suggest_link_clients.unlink_selected_client** (nested_function, lines 14849–14878, 30 lines, risk `support`): Unlink the selected client (clears person_uid for the whole link group).
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._maybe_suggest_link_clients.import_missing** (nested_function, lines 14880–14883, 4 lines, risk `reports`): Handles import missing for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._maybe_suggest_link_clients.import_from_excel** (nested_function, lines 14885–14946, 62 lines, risk `database_read`): Handles import from excel for the data bank feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._maybe_suggest_link_clients.export_monthly_template** (nested_function, lines 14948–15001, 54 lines, risk `support`): Export an Excel template for the current visible month (view-only data entry). Columns: Client Name + one column per date (YYYY-MM-DD). Users will fill payments in Excel and use 'Import from Excel' to load into the app.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._maybe_suggest_link_clients.import_clients_from_excel** (nested_function, lines 15003–15317, 315 lines, risk `filesystem`): Import ONLY client details from an Excel file into the Clients DB. Multi-loan-type safe: - If the sheet has a "Loan Type" column, it imports per-row (Regular / 7x7). - Otherwise, it imports into the CURRENT view mode (top selector).
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._maybe_suggest_link_clients.import_clients_from_excel._norm_lt** (nested_function, lines 15024–15032, 9 lines, risk `filesystem`): Handles norm lt for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._maybe_suggest_link_clients.import_clients_from_excel.to_date** (nested_function, lines 15036–15051, 16 lines, risk `support`): Handles to date for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._maybe_suggest_link_clients.import_clients_from_excel.to_float** (nested_function, lines 15053–15059, 7 lines, risk `filesystem`): Handles to float for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._maybe_suggest_link_clients.export_clients_template** (nested_function, lines 15801–15835, 35 lines, risk `support`): Export a blank Excel template for importing client details. Columns: Client Name | Area | Principal | Date Released | Due Date
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._maybe_suggest_link_clients.export_range_template** (nested_function, lines 15837–15960, 124 lines, risk `ui_only`): Export an Excel template for payments over a chosen date range. Presets: This Month / This Year / Custom (YYYY-MM-DD).
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._maybe_suggest_link_clients.export_range_template.on_sel** (nested_function, lines 15872–15874, 3 lines, risk `ui_only`): Handles on sel for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._maybe_suggest_link_clients.export_range_template._ok** (nested_function, lines 15880–15880, 1 lines, risk `support`): Handles ok for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._maybe_suggest_link_clients.export_range_template._cancel** (nested_function, lines 15881–15881, 1 lines, risk `support`): Handles cancel for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._maybe_suggest_link_clients.attach_direct_integration** (nested_function, lines 15962–16401, 440 lines, risk `database_write`): Minimal integration after removing undo/redo/backups. - Ensures a DB is attached - Wraps Excel import with a safe error dialog (if present) - Triggers initial UI refreshes (if methods exist)
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._maybe_suggest_link_clients._attempt_attach_on_run** (nested_function, lines 16404–16415, 12 lines, risk `reports`): Handles attempt attach on run for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._maybe_suggest_link_clients.push** (nested_function, lines 16442–16451, 10 lines, risk `support`): Handles push for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._maybe_suggest_link_clients.push.__init__** (nested_function, lines 16446–16447, 2 lines, risk `support`): Handles init for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._maybe_suggest_link_clients.push.push** (nested_function, lines 16449–16451, 3 lines, risk `support`): Handles push for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._maybe_suggest_link_clients.attach_refresh_all** (nested_function, lines 16453–16478, 26 lines, risk `support`): Attach a refresh_all method to app_obj that calls common updating hooks if they exist.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._maybe_suggest_link_clients.attach_refresh_all.refresh_all** (nested_function, lines 16455–16476, 22 lines, risk `reports`): Refreshes refresh all for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._maybe_suggest_link_clients.safe_excel_import** (nested_function, lines 16480–16513, 34 lines, risk `support`): import_fn should accept a file path and return a list of dicts or raise an error.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._maybe_suggest_link_clients.safe_excel_import.wrapper** (nested_function, lines 16485–16511, 27 lines, risk `reports`): Handles wrapper for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._maybe_suggest_link_clients.auto_attach_enhancements** (nested_function, lines 16515–16536, 22 lines, risk `reports`): Search module globals for an App-like object and attach enhancements. Call this function at the bottom of the file or from interactive session once the app is created.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.export_range_template** (function, lines 16632–16810, 179 lines, risk `ui_only`): Export an Excel template for payments over a chosen date range. Presets: This Month / This Year / Custom (YYYY-MM-DD).
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.export_range_template._today_parts** (nested_function, lines 16672–16674, 3 lines, risk `support`): Handles today parts for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.export_range_template._apply_preset_fields** (nested_function, lines 16676–16695, 20 lines, risk `ui_only`): Handles apply preset fields for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.export_range_template.on_ok** (nested_function, lines 16703–16717, 15 lines, risk `support`): Handles on ok for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.export_range_template.on_cancel** (nested_function, lines 16719–16720, 2 lines, risk `support`): Handles on cancel for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._parse_adv_range_any** (function, lines 16829–16846, 18 lines, risk `support`): Handles parse adv range any for the utilities feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._daterange_inclusive** (function, lines 16848–16852, 5 lines, risk `support`): Handles daterange inclusive for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._parse_reason_color_token** (function, lines 16872–16895, 24 lines, risk `support`): Extract a [RC:...] token (hex or a color-name) from the description. Returns: (color_hex or "", desc_without_token)
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._parse_reason_color_token_meta** (function, lines 16898–16971, 74 lines, risk `support`): Extract [RC:...] token plus optional window meta from the description. Supported token payloads (inside the brackets): - '#RRGGBB' - 'red' / 'green' / etc - '#RRGGBB;D:3' -> days=3 (inclusive, starting from the reason's date) - '#RRGGBB;UNTIL:YYYY-MM-DD' -> until (inclusive) - 'red;D:3' / 'red;UNTIL
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._strip_adv_tags** (function, lines 16975–16983, 9 lines, risk `support`): Remove [ADV:...] tags from a description string.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._extract_reason_and_color_from_desc** (function, lines 16985–16997, 13 lines, risk `support`): Return (reason_text, color_hex) from a transaction description. - Removes [ADV:...] tags - Extracts and removes [RC:...] token (optional ';D:n' / ';UNTIL:YYYY-MM-DD') - Returns trimmed reason text (may be empty)
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._extract_reason_color_meta_from_desc** (function, lines 16999–17009, 11 lines, risk `support`): Return (reason_text, color_hex, meta) from a transaction description. meta = {'days': int|None, 'until': date|None}
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._hex_to_rgb01** (function, lines 17011–17023, 13 lines, risk `support`): '#RRGGBB' -> (r,g,b) floats 0..1
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._normalize_client_name_for_lookup** (function, lines 17026–17048, 23 lines, risk `support`): Normalize a display name back to the DB name (Collector Route / PDFs). Some PDF layouts append markers like "(7x7)" to the displayed name to avoid duplicates. Those markers must be stripped before looking up transactions/reasons/ADV in SQLite. We also trim and normalize whitespace.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._get_reason_color_for_client_date** (function, lines 17050–17163, 114 lines, risk `filesystem`): Return the active reason color for this client on this day (Collector Route only). Behavior: - If the reason token has no window (no D/UNTIL), color applies ONLY on the reason's date. - If token has D:n, color applies for n days starting from the reason's date. - If token has UNTIL:YYYY-MM-DD, color
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._collect_day_flags_for_month** (function, lines 17167–17311, 145 lines, risk `support`): txns: iterable of dicts/rows having keys: 'date'|'d', 'payment'|'amt', 'description'|'desc' Returns dict: day(date)-> {'adv':bool, 'adv_paid_on':set(str), 'reason':str or None, 'paid':float} Reporting rules: - ADV is marked ONLY on the COVERED days (NOT on the payment date). - Covered days also stor
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._collect_day_flags_for_month._gv** (nested_function, lines 17176–17187, 12 lines, risk `support`): Handles gv for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._collect_day_flags_for_month._row_date** (nested_function, lines 17189–17199, 11 lines, risk `support`): Handles row date for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._collect_day_flags_for_month._adv_ranges_from_desc** (nested_function, lines 17201–17232, 32 lines, risk `support`): Return list of (start_date, end_date) as date objects.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_record_report_generation** (function, lines 17322–17463, 142 lines, risk `filesystem`): Increment and return the daily Generate Report counter. Stored in: - data/report_generation_counts.json (summary counts) - data/report_generation_logs.csv (Excel-friendly full log) - data/report_generation_logs.jsonl (append-only full log) Counts: - total: all reports generated today - per client+lo
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.generate_client_pdf** (function, lines 17467–18651, 1185 lines, risk `financial_calculation`): Override: Client SOA PDF that expands ADV ranges to daily 'Adv' markers in the Payment column, and prints other reasons as text in Payment. Never prints long notes in the Date column. Layout: 3 columns per page, 11 rows per column.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.generate_client_pdf._display_loan_type_label** (nested_function, lines 17486–17493, 8 lines, risk `support`): Handles display loan type label for the loans feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.generate_client_pdf._gv** (nested_function, lines 17525–17532, 8 lines, risk `support`): Handles gv for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.generate_client_pdf._per_day_effective_payments** (nested_function, lines 17607–17639, 33 lines, risk `support`): Return ordered list of (date, effective_payment) using the same rule as totals: last non-zero wins; 0 does not overwrite a prior non-zero; ignore ADV-only marker rows.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.generate_client_pdf._safe** (nested_function, lines 17880–17903, 24 lines, risk `filesystem`): Handles safe for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.generate_client_pdf._hdr_php** (nested_function, lines 17961–17965, 5 lines, risk `support`): Handles hdr php for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.generate_client_pdf._draw_kv** (nested_function, lines 18016–18031, 16 lines, risk `support`): Handles draw kv for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.generate_client_pdf._draw_pair** (nested_function, lines 18033–18038, 6 lines, risk `support`): Handles draw pair for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.generate_client_pdf._draw_also_footer** (nested_function, lines 18097–18119, 23 lines, risk `backup`): Draw small footer note (subtle) on the current page.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.generate_client_pdf._php** (nested_function, lines 18129–18133, 5 lines, risk `support`): Handles php for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.generate_client_pdf._page_no_draw** (nested_function, lines 18261–18265, 5 lines, risk `support`): Handles page no draw for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.generate_client_pdf._draw_official_report_footer** (nested_function, lines 18267–18317, 51 lines, risk `backup`): Draw a small, subtle official-version label and daily Generate Report counter at the bottom. This footer is intentionally NOT styled like the big notes section. It is only a quiet authenticity/count marker near the bottom of the page.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.generate_client_pdf._payment_text_from_flag** (nested_function, lines 18346–18378, 33 lines, risk `support`): Handles payment text from flag for the payments feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.generate_client_pdf._build_month_entries** (nested_function, lines 18380–18405, 26 lines, risk `support`): Builds build month entries for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.generate_client_pdf._draw_month_block** (nested_function, lines 18407–18456, 50 lines, risk `support`): Handles draw month block for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.generate_client_pdf._estimate_note_block_h** (nested_function, lines 18551–18574, 24 lines, risk `support`): Handles estimate note block h for the notes feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._ensure_prefs_file** (function, lines 18658–18667, 10 lines, risk `reports`): Handles ensure prefs file for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._app__norm_lt_value** (function, lines 18677–18685, 9 lines, risk `filesystem`): Handles app norm lt value for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._app__other_lt** (function, lines 18687–18689, 3 lines, risk `support`): Handles app other lt for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._app__get_selected_client_name** (function, lines 18691–18701, 11 lines, risk `support`): Handles app get selected client name for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._app_refresh_clients** (function, lines 18714–18863, 150 lines, risk `financial_calculation`): Handles app refresh clients for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._app_schedule_refresh_clients** (function, lines 18865–18889, 25 lines, risk `ui_only`): Debounce Clients search so refresh doesn't run on every keystroke.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._app_add_client_dialog** (function, lines 18891–18934, 44 lines, risk `reports`): Handles app add client dialog for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._app_on_client_edit** (function, lines 18936–18985, 50 lines, risk `reports`): Handles app on client edit for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._app_delete_client_selected** (function, lines 18987–19009, 23 lines, risk `backup`): Handles app delete client selected for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._app_link_selected_client** (function, lines 19021–19142, 122 lines, risk `ui_only`): Handles app link selected client for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._app_link_selected_client.refresh_list** (nested_function, lines 19076–19081, 6 lines, risk `support`): Refreshes refresh list for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._app_link_selected_client.do_link** (nested_function, lines 19089–19131, 43 lines, risk `support`): Handles do link for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._app_unlink_selected_client** (function, lines 19144–19165, 22 lines, risk `support`): Handles app unlink selected client for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._app__maybe_suggest_link_clients** (function, lines 19167–19228, 62 lines, risk `support`): Handles app maybe suggest link clients for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._app_export_clients_template** (function, lines 19230–19254, 25 lines, risk `support`): Handles app export clients template for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._app_import_clients_from_excel** (function, lines 19256–19369, 114 lines, risk `reports`): Handles app import clients from excel for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._app_import_clients_from_excel.col_idx** (nested_function, lines 19285–19289, 5 lines, risk `support`): Handles col idx for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._app_import_missing** (function, lines 19371–19382, 12 lines, risk `support`): Handles app import missing for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.RenewDialog** (class, lines 19385–19902, 518 lines, risk `container`): Renew (reloan) dialog. Auto-computes **Released Cash** using: released_cash = max(0, new_principal - remaining_due) remaining_due is based on the current cycle: Regular: remaining_due = max(0, total_to_pay - paid_total) 7x7: remaining_due = remaining_principal + unpaid_interest_arrears You can still
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.RenewDialog.__init__** (method, lines 19397–19406, 10 lines, risk `support`): Handles init for the loans feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.RenewDialog._parse_float** (method, lines 19408–19419, 12 lines, risk `filesystem`): Handles parse float for the utilities feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.RenewDialog._valid_ymd** (method, lines 19421–19429, 9 lines, risk `support`): Handles valid ymd for the loans feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.RenewDialog._compute_stats** (method, lines 19431–19689, 259 lines, risk `financial_calculation`): Return dict with paid/remaining/suggested released cash (best-effort). Regular: remaining_due = max(0, total_to_pay - paid_total) 7x7: remaining_due = remaining_principal + unpaid_interest_arrears (arrears must be cleared first). Uses the same rule as the SOA: - Daily interest = ceil(remaining_princ
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.RenewDialog._set_manual_rc** (method, lines 19691–19697, 7 lines, risk `ui_only`): Updates set manual rc for the loans feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.RenewDialog._set_auto_rc** (method, lines 19699–19706, 8 lines, risk `ui_only`): Updates set auto rc for the loans feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.RenewDialog._recompute** (method, lines 19708–19739, 32 lines, risk `ui_only`): Handles recompute for the loans feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.RenewDialog.body** (method, lines 19741–19833, 93 lines, risk `financial_calculation`): Handles body for the loans feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.RenewDialog.body._row** (nested_function, lines 19746–19749, 4 lines, risk `ui_only`): Handles row for the loans feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.RenewDialog.validate** (method, lines 19835–19873, 39 lines, risk `financial_calculation`): Handles validate for the utilities feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.RenewDialog.apply** (method, lines 19875–19902, 28 lines, risk `financial_calculation`): Handles apply for the loans feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._app_renew_client_selected** (function, lines 19905–19986, 82 lines, risk `financial_calculation`): Renew (reloan) the selected client and update the client row + report stats.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._app_open_archived_clients_dialog** (function, lines 19989–20105, 117 lines, risk `backup`): Handles app open archived clients dialog for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._app_open_archived_clients_dialog.load_list** (nested_function, lines 20038–20056, 19 lines, risk `backup`): Loads load list for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._app_open_archived_clients_dialog.restore_selected** (nested_function, lines 20058–20082, 25 lines, risk `backup`): Handles restore selected for the backup feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._SpinaStartupCancelled** (class, lines 20137–20139, 3 lines, risk `container`): Internal signal used to stop layered App initialization after login cancellation.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.main** (function, lines 20279–20292, 14 lines, risk `ui_only`): Handles main for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._schedule_collectors_refresh** (function, lines 20331–20348, 18 lines, risk `ui_only`): Debounce refresh_collectors while typing in Search.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._clear_collectors_search_filters** (function, lines 20351–20376, 26 lines, risk `support`): Clear search + quick filters for Collector's Route UI.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.print_collector_route_daily_ledger** (function, lines 20380–20577, 198 lines, risk `filesystem`): Print the SELECTED collector's route using the same 3-column Daily Collection Ledger layout as `print_full_daily_ledger`, but ONLY for that collector's areas (no 'arrange all areas' step). - Uses selection() first (more reliable than focus()). - Reads collectors.json in multiple historical schemas. 
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.print_full_daily_ledger** (function, lines 20581–23803, 3223 lines, risk `financial_calculation`): Print a 3-column DAILY COLLECTION LEDGER with a small UI to change: - Ledger Date - Paper size and orientation - Areas order (arrange ALL areas)
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.print_full_daily_ledger._fetch_clients_for** (nested_function, lines 20618–20625, 8 lines, risk `support`): Loads fetch clients for for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.print_full_daily_ledger._s** (nested_function, lines 20648–20648, 1 lines, risk `support`): Handles s for the reports feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.print_full_daily_ledger._options_dialog** (nested_function, lines 20653–20714, 62 lines, risk `ui_only`): Handles options dialog for the reports feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.print_full_daily_ledger._options_dialog._ok** (nested_function, lines 20692–20694, 3 lines, risk `support`): Handles ok for the reports feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.print_full_daily_ledger._options_dialog._cancel** (nested_function, lines 20695–20697, 3 lines, risk `support`): Handles cancel for the reports feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.print_full_daily_ledger._arrange_areas_dialog** (nested_function, lines 20717–20790, 74 lines, risk `reports`): Handles arrange areas dialog for the reports feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.print_full_daily_ledger._arrange_areas_dialog._move** (nested_function, lines 20750–20763, 14 lines, risk `ui_only`): Handles move for the reports feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.print_full_daily_ledger._arrange_areas_dialog._ok** (nested_function, lines 20772–20773, 2 lines, risk `support`): Handles ok for the reports feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.print_full_daily_ledger._arrange_areas_dialog._cancel** (nested_function, lines 20774–20775, 2 lines, risk `support`): Handles cancel for the reports feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.print_full_daily_ledger._wrap_text_to_width** (nested_function, lines 21875–21902, 28 lines, risk `support`): Handles wrap text to width for the reports feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.print_full_daily_ledger._wrap_text_to_width._fits** (nested_function, lines 21880–21880, 1 lines, risk `support`): Handles fits for the reports feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.print_full_daily_ledger._draw_page_number** (nested_function, lines 21904–21910, 7 lines, risk `support`): Handles draw page number for the reports feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.print_full_daily_ledger._draw_final_footer** (nested_function, lines 21912–21927, 16 lines, risk `support`): Handles draw final footer for the reports feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.print_full_daily_ledger._draw_global_header** (nested_function, lines 21928–21973, 46 lines, risk `support`): Handles draw global header for the reports feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.print_full_daily_ledger.new_page_headers** (nested_function, lines 21992–22022, 31 lines, risk `support`): Handles new page headers for the reports feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.print_full_daily_ledger.ensure_space** (nested_function, lines 22028–22047, 20 lines, risk `support`): Handles ensure space for the reports feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.print_full_daily_ledger._draw_closed_route_payment_summary_page** (nested_function, lines 23581–23768, 188 lines, risk `support`): Append closed-route payment summaries on a separate page. This keeps the route pages in the normal collector format while still saving a complete area-by-area payment summary plus grand total.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.print_full_daily_ledger._draw_closed_route_payment_summary_page._fmt_summary_money** (nested_function, lines 23594–23604, 11 lines, risk `support`): Handles fmt summary money for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.print_full_daily_ledger._draw_closed_route_payment_summary_page._as_float** (nested_function, lines 23606–23610, 5 lines, risk `support`): Handles as float for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.print_full_daily_ledger._draw_closed_route_payment_summary_page._draw_summary_header** (nested_function, lines 23656–23698, 43 lines, risk `support`): Handles draw summary header for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed.print_full_daily_ledger._draw_closed_route_payment_summary_page._draw_summary_row** (nested_function, lines 23700–23729, 30 lines, risk `backup`): Handles draw summary row for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._on_collectors_tree_wheel** (function, lines 23811–23831, 21 lines, risk `ui_only`): Ensure mousewheel scroll works on Collector Route list (Treeview).
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._save_collector_notes** (function, lines 23833–23895, 63 lines, risk `support`): Update one collector's notes in collectors.json (atomic, normalized schema).
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._save_selected_collector_notes** (function, lines 23897–23935, 39 lines, risk `support`): Save Notes from the right panel to collectors.json (atomic).
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._on_collectors_multi_toggle** (function, lines 23990–24009, 20 lines, risk `support`): Toggle multi-select mode for Collector Route list (checkbox Sel column).
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._on_collectors_tree_wheel** (function, lines 24012–24045, 34 lines, risk `ui_only`): Mouse wheel scroll for Collector Route list (Treeview).
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._on_collectors_tree_click** (function, lines 24048–24148, 101 lines, risk `filesystem`): Handle click in Sel / Actions columns without breaking row selection.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._delete_selected_collector** (function, lines 24151–24181, 31 lines, risk `support`): Safe delete action used by keybinds/buttons/menus.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._edit_selected_collector** (function, lines 24184–24198, 15 lines, risk `support`): Safe edit action for the context menu ('Full Editor…').
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._collectors_areas_drag_motion** (function, lines 24201–24243, 43 lines, risk `ui_only`): Drag-to-reorder areas listbox (MOVE item) without index-shift bugs.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina__ensure_client_picture_column** (function, lines 24297–24309, 13 lines, risk `database_write`): Best-effort lazy migration for client_picture support.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina__client_pictures_dir** (function, lines 24312–24321, 10 lines, risk `support`): Handles spina client pictures dir for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina__resolve_app_path** (function, lines 24324–24341, 18 lines, risk `backup`): Handles spina resolve app path for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina__store_client_picture_file** (function, lines 24344–24381, 38 lines, risk `filesystem`): Handles spina store client picture file for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina__delete_client_picture_file** (function, lines 24384–24396, 13 lines, risk `filesystem`): Handles spina delete client picture file for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._db_set_client_picture** (function, lines 24409–24440, 32 lines, risk `database_write`): Handles db set client picture for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._db_clear_client_picture** (function, lines 24443–24472, 30 lines, risk `database_write`): Handles db clear client picture for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._app_refresh_client_picture_panel** (function, lines 24477–24561, 85 lines, risk `filesystem`): Handles app refresh client picture panel for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._app_set_selected_client_picture** (function, lines 24564–24587, 24 lines, risk `support`): Handles app set selected client picture for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._app_clear_selected_client_picture** (function, lines 24590–24615, 26 lines, risk `support`): Handles app clear selected client picture for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_perf_ensure_indexes** (function, lines 24671–24713, 43 lines, risk `database_write`): Create helpful indexes for large datasets. Safe/idempotent.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_perf_norm_lt** (function, lines 24716–24723, 8 lines, risk `filesystem`): Handles spina perf norm lt for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_perf_month_transactions** (function, lines 24737–24804, 68 lines, risk `database_read`): Return {(row_key, yyyy-mm-dd): payment} for visible clients in the month using one range query.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_perf_month_transactions._chunks** (nested_function, lines 24761–24763, 3 lines, risk `support`): Handles chunks for the payments feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_archive_row_to_dict** (function, lines 24830–24841, 12 lines, risk `backup`): Handles spina archive row to dict for the backup feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_fixed_archive_client** (function, lines 24844–24873, 30 lines, risk `database_write`): Soft-delete: hide the client while keeping transactions/history. Fix: after archiving, fetch the new row with include_archived=True so history can still see the archived row instead of getting an empty new_row.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_fixed_restore_client** (function, lines 24876–24916, 41 lines, risk `database_write`): Restore a previously archived client by name + loan type. Important fix: the old code called get_client_info() without include_archived=True. Because archived rows are hidden by default, restore failed with "Client not found".
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_fixed_restore_client_by_uid** (function, lines 24919–24939, 21 lines, risk `backup`): Restore archived client by UID, with name/type fallback support.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_fixed_open_archived_clients_dialog** (function, lines 24942–25077, 136 lines, risk `backup`): Archived clients restore dialog with UID fallback and refresh after restore.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_fixed_open_archived_clients_dialog.load_list** (nested_function, lines 24992–25018, 27 lines, risk `backup`): Loads load list for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_fixed_open_archived_clients_dialog.restore_selected** (nested_function, lines 25020–25060, 41 lines, risk `backup`): Handles restore selected for the backup feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_fixed_get_archived_clients_with_id** (function, lines 25100–25157, 58 lines, risk `backup`): List archived clients and include the internal row id for reliable restore.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_fixed_restore_client_by_id** (function, lines 25160–25197, 38 lines, risk `database_write`): Restore archived client by exact clients.id row.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_fixed_open_archived_clients_dialog_rowid** (function, lines 25200–25336, 137 lines, risk `backup`): Archived clients restore dialog that restores by clients.id first.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_fixed_open_archived_clients_dialog_rowid._rowid_from_iid** (nested_function, lines 25241–25254, 14 lines, risk `support`): Handles rowid from iid for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_fixed_open_archived_clients_dialog_rowid.load_list** (nested_function, lines 25256–25284, 29 lines, risk `backup`): Loads load list for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_fixed_open_archived_clients_dialog_rowid.restore_selected** (nested_function, lines 25286–25321, 36 lines, risk `backup`): Handles restore selected for the backup feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_dash__norm_lt** (function, lines 25359–25364, 6 lines, risk `filesystem`): Handles spina dash norm lt for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_dashboard_fetch_rows** (function, lines 25385–25646, 262 lines, risk `financial_calculation`): Return active client completion rows using payments from latest released date only. Latest released date = max(clients.date_released, latest renewals.renew_date). Payment start = latest released date + clients.pay_start_offset_days (normalized to 0/1 day).
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_dashboard_fetch_rows._table_exists** (nested_function, lines 25400–25405, 6 lines, risk `database_read`): Handles table exists for the dashboard feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_dashboard_fetch_rows._table_cols** (nested_function, lines 25407–25411, 5 lines, risk `database_read`): Handles table cols for the dashboard feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_dashboard_fetch_rows._c** (nested_function, lines 25419–25420, 2 lines, risk `support`): Handles c for the dashboard feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_dashboard_fetch_rows._rv** (nested_function, lines 25484–25491, 8 lines, risk `support`): Handles rv for the dashboard feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_cashctl__fmt_money** (function, lines 25751–25761, 11 lines, risk `support`): Handles spina cashctl fmt money for the cash control feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_cashctl__parse_percent** (function, lines 25770–25786, 17 lines, risk `filesystem`): Parse a percent input like '10', '10%', or '0.10'. Returns 0..100.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_cashctl_get_collection_totals** (function, lines 25795–25849, 55 lines, risk `database_read`): Return combined collection totals for one day. Combined Collected = Regular + 7x7 + any transaction without a clean loan_type. This intentionally uses the Data Bank transactions total, not only one payment mode.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_cashctl_get_average_collection** (function, lines 25852–25908, 57 lines, risk `database_read`): Average daily collection before the selected date. Uses the last N calendar days before the selected date, then averages only days that actually have collections. This is better for forecasting collection days than dividing by every calendar day, especially when there are no-collection days.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_cashctl__ceil_thousand_units** (function, lines 25913–25923, 11 lines, risk `support`): Handles spina cashctl ceil thousand units for the cash control feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_cashctl__x7_daily_interest** (function, lines 25926–25928, 3 lines, risk `financial_calculation`): 7x7 daily interest: 1..1000=7/day, 1001..2000=14/day, etc.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_cashctl_estimated_payoff_with_interest** (function, lines 25931–26049, 119 lines, risk `financial_calculation`): Estimate payoff collection for renewal, including interest. Regular: uses the dashboard remaining balance, which is based on total_to_pay. total_to_pay is corrected to principal + interest_amount when needed. 7x7: splits current-cycle payments into interest first, then principal, and includes unpaid
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_cashctl_reserve_rows** (function, lines 26052–26146, 95 lines, risk `financial_calculation`): Rows to reserve cash for possible renewals. IMPORTANT: Cash Control now includes ALL active clients in the reserve list, not only near-completion clients. Near-completion / due-soon rules are used only as priority labels so the owner can see who is urgent first. Reserve basis is the current principa
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_cashctl_build_tab** (function, lines 26149–26273, 125 lines, risk `ui_only`): Handles spina cashctl build tab for the cash control feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_cashctl_refresh** (function, lines 26276–26388, 113 lines, risk `financial_calculation`): Handles spina cashctl refresh for the cash control feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_cashctl_apply_role** (function, lines 26391–26415, 25 lines, risk `authentication`): Handles spina cashctl apply role for the cash control feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._populate_collector_details** (function, lines 26473–26567, 95 lines, risk `support`): Update the right panel: selected name, stats, areas tree, notes.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._on_collectors_select** (function, lines 26570–26635, 66 lines, risk `ui_only`): Populate the right-side details panel for the selected collector.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_cilog_field_label** (function, lines 26660–26690, 31 lines, risk `filesystem`): Handles spina cilog field label for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_cilog_fetch_rows** (function, lines 26699–26758, 60 lines, risk `database_write`): Handles spina cilog fetch rows for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_auto_close_after_days_value** (function, lines 26811–26825, 15 lines, risk `support`): Return the configured auto-close delay in days. 0 = disabled.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_auto_close_candidate_dates** (function, lines 26828–26860, 33 lines, risk `database_read`): Return transaction dates up to cutoff that are not already closed.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_schedule_auto_daily_close** (function, lines 26867–26884, 18 lines, risk `ui_only`): Run auto close now and then check periodically while the app is open.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina__parse_flexible_due_rule** (function, lines 26912–27075, 164 lines, risk `support`): Return (label, due_today_bool) for optional flex_due_rule. Supported examples: - salary 15/30 window 2 -> due from 13-17 and last-day-2 through last-day+2 if valid - weekly Monday Thursday -> due every Monday and Thursday - 2nd Saturday -> due every 2nd Saturday of the month - days 13,14,15,29,30,31
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_route_notice_norm_lt** (function, lines 27100–27105, 6 lines, risk `filesystem`): Handles spina route notice norm lt for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_route_notice_key** (function, lines 27107–27112, 6 lines, risk `support`): Handles spina route notice key for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_route_notice_load** (function, lines 27114–27125, 12 lines, risk `filesystem`): Handles spina route notice load for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_route_notice_save** (function, lines 27127–27138, 12 lines, risk `support`): Handles spina route notice save for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_route_notice_upsert** (function, lines 27140–27172, 33 lines, risk `support`): Handles spina route notice upsert for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_route_balance_like_generate_report** (function, lines 27182–27364, 183 lines, risk `financial_calculation`): Return the same Balance basis used by Generate Report PDF. Regular: total_to_pay (corrected to principal + interest when needed) minus effective current-cycle payments. 7x7: remaining principal after the Generate Report interest-first payment split. This intentionally matches the report header Balan
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_crc_norm_lt** (function, lines 27372–27377, 6 lines, risk `filesystem`): Handles spina crc norm lt for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_crc_clean_reason** (function, lines 27383–27396, 14 lines, risk `support`): Handles spina crc clean reason for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_crc_load_collectors** (function, lines 27399–27441, 43 lines, risk `filesystem`): Load collector route definitions from data/collectors.json in any supported schema.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_crc_split_area** (function, lines 27444–27456, 13 lines, risk `support`): Handles spina crc split area for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_crc_route_area_matches** (function, lines 27459–27483, 25 lines, risk `support`): Match route area to client area, including MAIN-only collector routes covering subareas.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_crc_collector_for_area** (function, lines 27486–27494, 9 lines, risk `support`): Handles spina crc collector for area for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_crc_key** (function, lines 27497–27501, 5 lines, risk `support`): Handles spina crc key for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_crc_fetch_close_rows** (function, lines 27504–27670, 167 lines, risk `database_read`): Build route rows with amount paid on the close date.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_crc_fetch_close_rows._add_pay** (nested_function, lines 27550–27559, 10 lines, risk `support`): Handles add pay for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_crc_wrap** (function, lines 27673–27695, 23 lines, risk `support`): Handles spina crc wrap for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_crc_copy_existing_route_pdfs** (function, lines 27698–27730, 33 lines, risk `filesystem`): Handles spina crc copy existing route pdfs for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_crc_build_paid_cache_for_date** (function, lines 27747–27779, 33 lines, risk `database_read`): Return {(lower_name, lower_loan_type): paid_amount} for the closed date.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_crc_active_filtered_areas_for_collector** (function, lines 27782–27834, 53 lines, risk `database_read`): Match the Collector Route screen filtering so blank/archived-only areas are skipped.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_save_closed_collector_route_copy_same_format** (function, lines 27837–28006, 170 lines, risk `filesystem`): Save final closed Collector Route copy using the SAME Collector Route PDF layout. Difference from normal print: the payment columns are filled with the actual amount paid on the closed date, and the PDF is saved silently under data/Closed_Collector_Routes.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_save_closed_collector_route_copy_same_format._safe_tag** (nested_function, lines 27872–27876, 5 lines, risk `filesystem`): Handles safe tag for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_save_closed_collector_route_copy_same_format._generate_one** (nested_function, lines 27878–27936, 59 lines, risk `filesystem`): Generates generate one for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_pg__reset_id_sequence** (function, lines 28030–28050, 21 lines, risk `database_read`): Move a PostgreSQL BIGSERIAL/SERIAL sequence after the current MAX(id).
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_pg__table_has_column** (function, lines 28053–28068, 16 lines, risk `database_read`): Handles spina pg table has column for the database feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_pg_renew_client_direct** (function, lines 28071–28296, 226 lines, risk `financial_calculation`): PostgreSQL-safe renew/reloan implementation for the TEST build.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_route_adv_marker_for** (function, lines 28311–28483, 173 lines, risk `filesystem`): Collector Route ADV lookup with stronger PostgreSQL migration fallback. This version does not rely only on the printed route name. It finds the client_uid/person_uid from clients first, then checks every matching transaction name/uid for the selected loan type. This fixes migrated data where a linke
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_v21_cash_refresh** (function, lines 28843–29011, 169 lines, risk `financial_calculation`): Handles spina v21 cash refresh for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_v23_client_loan_summary** (function, lines 29097–29153, 57 lines, risk `financial_calculation`): Handles spina v23 client loan summary for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_v23_client_form** (function, lines 29164–29620, 457 lines, risk `ui_only`): Handles spina v23 client form for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_v23_client_form.norm_lt** (nested_function, lines 29168–29173, 6 lines, risk `filesystem`): Handles norm lt for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_v23_client_form._on_content_config** (nested_function, lines 29244–29249, 6 lines, risk `ui_only`): Handles on content config for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_v23_client_form._load_pic_preview** (nested_function, lines 29272–29299, 28 lines, risk `filesystem`): Loads load pic preview for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_v23_client_form._choose_picture** (nested_function, lines 29301–29312, 12 lines, risk `ui_only`): Handles choose picture for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_v23_client_form._clear_picture** (nested_function, lines 29314–29320, 7 lines, risk `ui_only`): Handles clear picture for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_v23_client_form.section** (nested_function, lines 29342–29352, 11 lines, risk `ui_only`): Handles section for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_v23_client_form.calc_row** (nested_function, lines 29414–29418, 5 lines, risk `ui_only`): Handles calc row for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_v23_client_form._parse_float_var** (nested_function, lines 29426–29431, 6 lines, risk `filesystem`): Handles parse float var for the utilities feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_v23_client_form._sync_dates_and_calc** (nested_function, lines 29433–29471, 39 lines, risk `support`): Handles sync dates and calc for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_v23_client_form._validate_date** (nested_function, lines 29486–29491, 6 lines, risk `support`): Validates validate date for the utilities feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_v23_client_form._norm_dom** (nested_function, lines 29493–29505, 13 lines, risk `support`): Handles norm dom for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_v23_client_form.save** (nested_function, lines 29507–29594, 88 lines, risk `support`): Handles save for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_v23_client_form.cancel** (nested_function, lines 29596–29600, 5 lines, risk `support`): Handles cancel for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_v23_add_client_dialog** (function, lines 29623–29672, 50 lines, risk `reports`): Handles spina v23 add client dialog for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_v23_on_client_edit** (function, lines 29675–29741, 67 lines, risk `reports`): Handles spina v23 on client edit for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_v27_get_route_master_areas** (function, lines 29961–29992, 32 lines, risk `support`): Handles spina v27 get route master areas for the collectors feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_v32_account_default_name** (function, lines 30080–30088, 9 lines, risk `support`): Handles spina v32 account default name for the authentication feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_v32_account_display_name** (function, lines 30097–30107, 11 lines, risk `authentication`): Handles spina v32 account display name for the authentication feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_v32_account_role** (function, lines 30110–30120, 11 lines, risk `authentication`): Handles spina v32 account role for the authentication feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_v32_account_choices** (function, lines 30123–30151, 29 lines, risk `authentication`): Handles spina v32 account choices for the authentication feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_v32_selected_label_for_user** (function, lines 30154–30159, 6 lines, risk `support`): Handles spina v32 selected label for user for the other feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_v32_make_users_account_based** (function, lines 30162–30216, 55 lines, risk `authentication`): Add account display metadata while preserving existing usernames/passwords/access.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_v32_switch_account** (function, lines 30236–30293, 58 lines, risk `authentication`): Handles spina v32 switch account for the authentication feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_v32_prompt_user_role** (function, lines 30296–30299, 4 lines, risk `authentication`): Handles spina v32 prompt user role for the authentication feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_legacy_client_action_removed_message** (function, lines 30331–30342, 12 lines, risk `reports`): Handles spina legacy client action removed message for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_make_removed_legacy_client_action** (function, lines 30345–30350, 6 lines, risk `filesystem`): Handles spina make removed legacy client action for the clients feature.
- **OFFICIAL_SPINA_APP_PostgreSQL_TEST_v33_stability_performance_fixed._spina_make_removed_legacy_client_action._spina_removed_action** (nested_function, lines 30346–30348, 3 lines, risk `support`): Handles spina removed action for the clients feature.
...
- **spina_app.backup_history_presentation.configure_backup_history_dependencies** (function, lines 14–19, 6 lines, risk `backup`): Handles configure backup history dependencies for the backup feature.
- **spina_app.backup_history_presentation.open_backup_history_window** (function, lines 23–204, 182 lines, risk `backup`): Show backup files and provide verify/restore-test actions.
...
## `spina_app/client_new_status.py`

- **spina_app.client_new_status.configure_client_new_status_dependencies** (function, lines 9–15, 7 lines, risk `support`): Configure the existing ledger-preferences loader used by the desktop app.
- **spina_app.client_new_status._is_client_new** (function, lines 18–135, 118 lines, risk `reports`): Return True if client is NEW. Rules: - If 'new_until' is explicitly set in the DB: * If it's an empty string or unparsable -> treat as explicit OFF (return False). * If it's a valid date -> return (ledger_date <= new_until). No fallback. - Otherwise (no explicit 'new_until' value present): * If 'day
...
## `spina_app/client_statement_generation.py`

- **spina_app.client_statement_generation.configure_client_statement_generation_dependencies** (function, lines 14–19, 6 lines, risk `reports`): Handles configure client statement generation dependencies for the clients feature.
- **spina_app.client_statement_generation.generate_pdf_selected** (function, lines 23–280, 258 lines, risk `reports`): Generate a client statement PDF without freezing the UI.
- **spina_app.client_statement_generation.generate_pdf_selected._effective_cycle_start** (nested_function, lines 35–79, 45 lines, risk `filesystem`): Normalize the current cycle start the same way the client screen and report body do. This prevents renewed clients from inheriting a stale earlier report start range.
- **spina_app.client_statement_generation.generate_pdf_selected._work** (nested_function, lines 199–259, 61 lines, risk `filesystem`): Handles work for the clients feature.
- **spina_app.client_statement_generation.generate_pdf_selected._done** (nested_function, lines 261–271, 11 lines, risk `support`): Handles done for the clients feature.
- **spina_app.client_statement_generation.generate_pdf_selected._err** (nested_function, lines 273–278, 6 lines, risk `support`): Handles err for the clients feature.

## `spina_app/clients_tab_presentation.py`

- **spina_app.clients_tab_presentation.configure_clients_tab_presentation_dependencies** (function, lines 7–12, 6 lines, risk `support`): Handles configure clients tab presentation dependencies for the clients feature.
- **spina_app.clients_tab_presentation._build_clients_tab** (function, lines 22–177, 156 lines, risk `ui_only`): Builds build clients tab for the clients feature.
...
## `spina_app/databank_cell_writes.py`

- **spina_app.databank_cell_writes.configure_databank_cell_write_dependencies** (function, lines 7–12, 6 lines, risk `support`): Handles configure databank cell write dependencies for the data bank feature.
- **spina_app.databank_cell_writes._save_cell_edit** (function, lines 16–99, 84 lines, risk `filesystem`): Save an edited day-cell value into the DB (no undo/redo). - amount == 0 → prompt for reason (stored in description) - amount > 0 → clears description
- **spina_app.databank_cell_writes.delete_selected_cell** (function, lines 102–189, 88 lines, risk `support`): Removes delete selected cell for the data bank feature.
- **spina_app.databank_cell_writes._mark_missed_for_selected** (function, lines 192–262, 71 lines, risk `filesystem`): Right-click action in Data Bank: set selected day as MISSED (0.0) with a reason.

## `spina_app/databank_close_history_presentation.py`

- **spina_app.databank_close_history_presentation.configure_databank_close_history_presentation_dependencies** (function, lines 7–12, 6 lines, risk `support`): Handles configure databank close history presentation dependencies for the data bank feature.
- **spina_app.databank_close_history_presentation.open_databank_close_history_dialog** (function, lines 22–92, 71 lines, risk `ui_only`): Handles open databank close history dialog for the data bank feature.

## `spina_app/databank_close_records_presentation.py`

- **spina_app.databank_close_records_presentation.configure_databank_close_records_dependencies** (function, lines 14–19, 6 lines, risk `support`): Handles configure databank close records dependencies for the data bank feature.
- **spina_app.databank_close_records_presentation.open_databank_close_records_dialog** (function, lines 23–246, 224 lines, risk `filesystem`): Handles open databank close records dialog for the data bank feature.
- **spina_app.databank_close_records_presentation.open_databank_close_records_dialog._coerce_date** (nested_function, lines 28–35, 8 lines, risk `support`): Handles coerce date for the data bank feature.
- **spina_app.databank_close_records_presentation.open_databank_close_records_dialog._fmt_amt** (nested_function, lines 144–151, 8 lines, risk `support`): Handles fmt amt for the data bank feature.
- **spina_app.databank_close_records_presentation.open_databank_close_records_dialog._selected_date** (nested_function, lines 153–158, 6 lines, risk `support`): Handles selected date for the data bank feature.
- **spina_app.databank_close_records_presentation.open_databank_close_records_dialog._load_records** (nested_function, lines 160–226, 67 lines, risk `filesystem`): Loads load records for the data bank feature.
- **spina_app.databank_close_records_presentation.open_databank_close_records_dialog._open_selected** (nested_function, lines 228–233, 6 lines, risk `support`): Handles open selected for the data bank feature.
- **spina_app.databank_close_records_presentation.open_databank_close_records_dialog._print_selected** (nested_function, lines 235–240, 6 lines, risk `reports`): Generates print selected for the reports feature.
...
- **spina_app.databank_editor_presentation.configure_databank_editor_dependencies** (function, lines 7–12, 6 lines, risk `support`): Handles configure databank editor dependencies for the data bank feature.
- **spina_app.databank_editor_presentation._pick_missed_reason** (function, lines 16–160, 145 lines, risk `ui_only`): Modal checkbox dialog to choose one or more missed-payment reasons, plus optional 'Other' note. If 'Advance' is selected, you can enter a date range. Returns a single string (joined reasons + optional [ADV:s..e] tag) or None if cancelled.
- **spina_app.databank_editor_presentation._pick_missed_reason.set_enabled** (nested_function, lines 67–74, 8 lines, risk `ui_only`): Updates set enabled for the data bank feature.
- **spina_app.databank_editor_presentation._pick_missed_reason.on_adv_toggle** (nested_function, lines 76–77, 2 lines, risk `support`): Handles on adv toggle for the data bank feature.
- **spina_app.databank_editor_presentation._pick_missed_reason._parse_any_date** (nested_function, lines 91–111, 21 lines, risk `support`): Handles parse any date for the utilities feature.
- **spina_app.databank_editor_presentation._pick_missed_reason.on_ok** (nested_function, lines 113–137, 25 lines, risk `support`): Handles on ok for the data bank feature.
- **spina_app.databank_editor_presentation._pick_missed_reason.on_cancel** (nested_function, lines 139–141, 3 lines, risk `support`): Handles on cancel for the data bank feature.
- **spina_app.databank_editor_presentation._walk_widgets** (function, lines 162–168, 7 lines, risk `support`): Handles walk widgets for the utilities feature.
- **spina_app.databank_editor_presentation._begin_cell_edit** (function, lines 170–311, 142 lines, risk `filesystem`): Create an Entry over the clicked (or remembered) day cell and save back to DB.
- **spina_app.databank_editor_presentation._begin_cell_edit._commit** (nested_function, lines 305–306, 2 lines, risk `support`): Handles commit for the data bank feature.
- **spina_app.databank_editor_presentation._remember_cell_click** (function, lines 313–331, 19 lines, risk `support`): Handles remember cell click for the data bank feature.

## `spina_app/databank_feature.py`

- **spina_app.databank_feature.configure_databank_feature_dependencies** (function, lines 3–7, 5 lines, risk `support`): Handles configure databank feature dependencies for the data bank feature.
- **spina_app.databank_feature._clear_preview** (function, lines 10–12, 3 lines, risk `support`): Handles clear preview for the data bank feature.
- **spina_app.databank_feature._get_databank_focus_date** (function, lines 15–37, 23 lines, risk `support`): Retrieves get databank focus date for the data bank feature.
- **spina_app.databank_feature._show_system_data_tab** (function, lines 40–49, 10 lines, risk `support`): Handles show system data tab for the data bank feature.
- **spina_app.databank_feature._hide_system_data_tab** (function, lines 52–57, 6 lines, risk `support`): Handles hide system data tab for the data bank feature.
- **spina_app.databank_feature._system_data_open_close** (function, lines 60–70, 11 lines, risk `support`): Handles system data open close for the data bank feature.
- **spina_app.databank_feature._system_data_open_history** (function, lines 73–77, 5 lines, risk `support`): Handles system data open history for the data bank feature.
- **spina_app.databank_feature._system_data_open_records** (function, lines 80–84, 5 lines, risk `support`): Handles system data open records for the data bank feature.
- **spina_app.databank_feature._system_data_print_report** (function, lines 87–91, 5 lines, risk `reports`): Handles system data print report for the data bank feature.
- **spina_app.databank_feature._load_collectors_route_map** (function, lines 94–133, 40 lines, risk `filesystem`): Loads load collectors route map for the collectors feature.
- **spina_app.databank_feature._build_databank_collector_defaults_for_date** (function, lines 136–205, 70 lines, risk `database_read`): Builds build databank collector defaults for date for the collectors feature.
- **spina_app.databank_feature._build_databank_collector_defaults_for_date._norm_area** (nested_function, lines 137–141, 5 lines, risk `support`): Handles norm area for the data bank feature.
- **spina_app.databank_feature.print_databank_close_report** (function, lines 208–442, 235 lines, risk `filesystem`): Generates print databank close report for the data bank feature.
- **spina_app.databank_feature.open_databank_close_dialog** (function, lines 445–1095, 651 lines, risk `reports`): Handles open databank close dialog for the data bank feature.
- **spina_app.databank_feature.open_databank_close_dialog._parse_amount** (nested_function, lines 496–501, 6 lines, risk `filesystem`): Handles parse amount for the utilities feature.
- **spina_app.databank_feature.open_databank_close_dialog._fmt_amount** (nested_function, lines 503–510, 8 lines, risk `support`): Handles fmt amount for the data bank feature.
- **spina_app.databank_feature.open_databank_close_dialog._variance_status** (nested_function, lines 512–519, 8 lines, risk `support`): Handles variance status for the data bank feature.
- **spina_app.databank_feature.open_databank_close_dialog._default_workflow** (nested_function, lines 521–526, 6 lines, risk `support`): Handles default workflow for the data bank feature.
- **spina_app.databank_feature.open_databank_close_dialog._selected_split_index** (nested_function, lines 623–630, 8 lines, risk `support`): Handles selected split index for the data bank feature.
- **spina_app.databank_feature.open_databank_close_dialog._clear_split_editor** (nested_function, lines 632–637, 6 lines, risk `support`): Handles clear split editor for the data bank feature.
- **spina_app.databank_feature.open_databank_close_dialog._refresh_split_tree** (nested_function, lines 639–686, 48 lines, risk `ui_only`): Refreshes refresh split tree for the data bank feature.
- **spina_app.databank_feature.open_databank_close_dialog._load_split_editor_from_selection** (nested_function, lines 688–700, 13 lines, risk `support`): Loads load split editor from selection for the data bank feature.
- **spina_app.databank_feature.open_databank_close_dialog._upsert_split_row** (nested_function, lines 702–733, 32 lines, risk `support`): Handles upsert split row for the data bank feature.
- **spina_app.databank_feature.open_databank_close_dialog._remove_split_row** (nested_function, lines 735–755, 21 lines, risk `support`): Removes remove split row for the data bank feature.
- **spina_app.databank_feature.open_databank_close_dialog._load_route_collectors** (nested_function, lines 757–769, 13 lines, risk `support`): Loads load route collectors for the collectors feature.
- **spina_app.databank_feature.open_databank_close_dialog._save_split** (nested_function, lines 771–789, 19 lines, risk `support`): Saves save split for the data bank feature.
- **spina_app.databank_feature.open_databank_close_dialog._apply_mode** (nested_function, lines 791–830, 40 lines, risk `ui_only`): Handles apply mode for the data bank feature.
- **spina_app.databank_feature.open_databank_close_dialog._recalc** (nested_function, lines 832–854, 23 lines, risk `support`): Handles recalc for the data bank feature.
- **spina_app.databank_feature.open_databank_close_dialog._load** (nested_function, lines 856–920, 65 lines, risk `support`): Handles load for the data bank feature.
- **spina_app.databank_feature.open_databank_close_dialog._close_day** (nested_function, lines 922–981, 60 lines, risk `authentication`): Handles close day for the data bank feature.
- **spina_app.databank_feature.open_databank_close_dialog._reopen_day** (nested_function, lines 983–1010, 28 lines, risk `authentication`): Handles reopen day for the data bank feature.
- **spina_app.databank_feature.open_databank_close_dialog._update_workflow** (nested_function, lines 1012–1041, 30 lines, risk `authentication`): Updates update workflow for the data bank feature.
- **spina_app.databank_feature.open_databank_close_dialog._print_report** (nested_function, lines 1043–1050, 8 lines, risk `reports`): Generates print report for the reports feature.
- **spina_app.databank_feature.open_databank_close_dialog._save_route_copy_now** (nested_function, lines 1052–1075, 24 lines, risk `support`): Saves save route copy now for the collectors feature.
- **spina_app.databank_feature.open_databank_close_dialog._open_records_list** (nested_function, lines 1077–1078, 2 lines, risk `support`): Handles open records list for the data bank feature.
- **spina_app.databank_feature.on_day_double** (function, lines 1098–1173, 76 lines, risk `filesystem`): Handles on day double for the data bank feature.
- **spina_app.databank_feature.on_day_double.save** (nested_function, lines 1122–1161, 40 lines, risk `ui_only`): Handles save for the data bank feature.
- **spina_app.databank_feature.on_day_double._close_editor** (nested_function, lines 1164–1169, 6 lines, risk `support`): Handles close editor for the data bank feature.
- **spina_app.databank_feature._start_edit** (function, lines 1176–1246, 71 lines, risk `filesystem`): Handles start edit for the data bank feature.
- **spina_app.databank_feature._start_edit.save** (nested_function, lines 1197–1235, 39 lines, risk `ui_only`): Handles save for the data bank feature.
- **spina_app.databank_feature._start_edit._close_editor** (nested_function, lines 1237–1242, 6 lines, risk `support`): Handles close editor for the data bank feature.
- **spina_app.databank_feature._import_from_excel_entry** (function, lines 1249–1290, 42 lines, risk `support`): Import payments from Excel. Supports: 1) Date-grid templates (first row has 'Client Name' + date columns like YYYY-MM-DD) via _import_from_excel_core() 2) One-day Daily Collection templates (Client | Payment | Reason), optionally grouped by [AREA] rows Notes: - Unknown clients are skipped (to avoid 
- **spina_app.databank_feature._import_from_excel_entry_worker** (function, lines 1293–1689, 397 lines, risk `support`): Worker for _import_from_excel_entry (runs off the Tk main thread).
- **spina_app.databank_feature._import_from_excel_entry_worker._norm** (nested_function, lines 1352–1354, 3 lines, risk `filesystem`): Handles norm for the data bank feature.
- **spina_app.databank_feature._import_from_excel_entry_worker._looks_like_date_header** (nested_function, lines 1356–1368, 13 lines, risk `support`): Handles looks like date header for the data bank feature.
- **spina_app.databank_feature._import_from_excel_entry_worker._parse_sheet** (nested_function, lines 1467–1600, 134 lines, risk `filesystem`): Handles parse sheet for the utilities feature.
- **spina_app.databank_feature._import_encoder_batch** (function, lines 1692–2111, 420 lines, risk `filesystem`): Import One-Day Encoder exports (.jsonl or .csv) into the DB. - Dedupe by record_id (preferred) or a content hash fallback - Unknown clients are skipped (no auto-create) - Advances are stored via description tag: [ADV:s..e; s..e; ...] (supports multiple ranges)
- **spina_app.databank_feature._import_encoder_batch._canon_lt** (nested_function, lines 1713–1717, 5 lines, risk `filesystem`): Handles canon lt for the data bank feature.
- **spina_app.databank_feature._import_encoder_batch._is_date** (nested_function, lines 1719–1721, 3 lines, risk `support`): Handles is date for the data bank feature.
- **spina_app.databank_feature._import_encoder_batch._adv_tag_from_ranges** (nested_function, lines 1723–1736, 14 lines, risk `support`): Handles adv tag from ranges for the data bank feature.
- **spina_app.databank_feature._import_encoder_batch._ilog** (nested_function, lines 1785–1789, 5 lines, risk `support`): Handles ilog for the data bank feature.
- **spina_app.databank_feature._import_from_excel_core** (function, lines 2114–2279, 166 lines, risk `database_read`): Auto-detect payments and reasons from Excel. Rules: " First row = headers. Must include 'Client Name' and at least one date column. " A date column can be an Excel date/datetime or a string 'YYYY-MM-DD'. " If a cell under a date column is numeric (or numeric-looking text): that's the amount. " If a 
- **spina_app.databank_feature._import_from_excel_core._parse_date_header** (nested_function, lines 2133–2144, 12 lines, risk `support`): Handles parse date header for the utilities feature.
- **spina_app.databank_feature._import_from_excel_core._to_number** (nested_function, lines 2146–2162, 17 lines, risk `filesystem`): Handles to number for the data bank feature.
- **spina_app.databank_feature._import_from_excel_core._is_text_reason** (nested_function, lines 2164–2171, 8 lines, risk `support`): Handles is text reason for the data bank feature.
- **spina_app.databank_feature.import_from_excel_with_reasons** (function, lines 2282–2430, 149 lines, risk `support`): Import the Excel 'range template' where columns are: Client Name | 2025-10-01 | 2025-10-01 Reason | 2025-10-02 | 2025-10-02 Reason | ... Saves both Amount and Reason for each date.
- **spina_app.databank_feature.import_from_excel_with_reasons._write** (nested_function, lines 2363–2430, 68 lines, risk `database_write`): Handles write for the data bank feature.
- **spina_app.databank_feature._spina_perf_refresh_data_grid** (function, lines 2433–2637, 205 lines, risk `ui_only`): Fast Data Bank month grid refresh using bulk month transaction query.
- **spina_app.databank_feature._spina_perf_refresh_data_grid._yview** (nested_function, lines 2481–2485, 5 lines, risk `support`): Handles yview for the data bank feature.
- **spina_app.databank_feature._spina_perf_refresh_data_grid._sync_selection** (nested_function, lines 2496–2508, 13 lines, risk `ui_only`): Handles sync selection for the data bank feature.
- **spina_app.databank_feature._spina_auto_close_one_day** (function, lines 2640–2682, 43 lines, risk `support`): Close one Data Bank day using system expected totals as the safe automatic actual amount.
- **spina_app.databank_feature._spina_run_auto_daily_close** (function, lines 2685–2763, 79 lines, risk `support`): Auto-close Data Bank dates that are older than the configured delay.
- **spina_app.databank_feature._spina_save_closed_collector_route_copy** (function, lines 2766–3046, 281 lines, risk `backup`): Save an audit copy of the Collector Route after Daily Close. The PDF contains the closed total/actual cash for the day and the amount paid by each client on that date. It is separate from Generate Report and from editable Data Bank rows.
- **spina_app.databank_feature._spina_save_closed_collector_route_copy._rec_get** (nested_function, lines 2795–2802, 8 lines, risk `support`): Handles rec get for the data bank feature.
- **spina_app.databank_feature._spina_save_closed_collector_route_copy._new_page** (nested_function, lines 2877–2881, 5 lines, risk `support`): Handles new page for the data bank feature.
- **spina_app.databank_feature._spina_save_closed_collector_route_copy._ensure** (nested_function, lines 2883–2885, 3 lines, risk `support`): Handles ensure for the data bank feature.
- **spina_app.databank_feature._spina_save_closed_collector_route_copy._draw_header** (nested_function, lines 2887–2917, 31 lines, risk `support`): Handles draw header for the data bank feature.
- **spina_app.databank_feature._spina_save_closed_collector_route_copy._draw_table_header** (nested_function, lines 2919–2934, 16 lines, risk `backup`): Handles draw table header for the data bank feature.

## `spina_app/databank_grid_presentation.py`

- **spina_app.databank_grid_presentation.configure_databank_grid_dependencies** (function, lines 7–12, 6 lines, risk `support`): Handles configure databank grid dependencies for the data bank feature.
- **spina_app.databank_grid_presentation.goto_current_month** (function, lines 16–20, 5 lines, risk `support`): Handles goto current month for the data bank feature.
- **spina_app.databank_grid_presentation.prev_month** (function, lines 22–25, 4 lines, risk `ui_only`): Handles prev month for the data bank feature.
- **spina_app.databank_grid_presentation.next_month** (function, lines 27–30, 4 lines, risk `ui_only`): Handles next month for the data bank feature.
- **spina_app.databank_grid_presentation.refresh_data_grid** (function, lines 32–302, 271 lines, risk `ui_only`): Refreshes refresh data grid for the data bank feature.
- **spina_app.databank_grid_presentation.refresh_data_grid._yview** (nested_function, lines 89–99, 11 lines, risk `support`): Handles yview for the data bank feature.
- **spina_app.databank_grid_presentation.refresh_data_grid._sync_selection** (nested_function, lines 114–128, 15 lines, risk `ui_only`): Handles sync selection for the data bank feature.
- **spina_app.databank_grid_presentation.refresh_data_grid._on_sel_left** (nested_function, lines 130–131, 2 lines, risk `support`): Handles on sel left for the data bank feature.
- **spina_app.databank_grid_presentation.refresh_data_grid._on_sel_right** (nested_function, lines 133–134, 2 lines, risk `support`): Handles on sel right for the data bank feature.
- **spina_app.databank_grid_presentation.refresh_data_grid._focus_right_from_left** (nested_function, lines 143–151, 9 lines, risk `ui_only`): Handles focus right from left for the data bank feature.
- **spina_app.databank_grid_presentation.refresh_data_grid._focus_left_from_right** (nested_function, lines 153–161, 9 lines, risk `ui_only`): Handles focus left from right for the data bank feature.
...
## `spina_app/reports_tab_presentation.py`

- **spina_app.reports_tab_presentation.configure_reports_tab_dependencies** (function, lines 13–18, 6 lines, risk `reports`): Handles configure reports tab dependencies for the reports feature.
- **spina_app.reports_tab_presentation._build_reports_tab** (function, lines 22–359, 338 lines, risk `filesystem`): Builds build reports tab for the reports feature.
- **spina_app.reports_tab_presentation._build_reports_tab._sync_reports_range** (nested_function, lines 45–65, 21 lines, risk `reports`): Handles sync reports range for the reports feature.
- **spina_app.reports_tab_presentation._build_reports_tab._apply_report_range_from_fields** (nested_function, lines 67–92, 26 lines, risk `reports`): Handles apply report range from fields for the reports feature.
- **spina_app.reports_tab_presentation._build_reports_tab._pick_reports_range** (nested_function, lines 94–96, 3 lines, risk `reports`): Handles pick reports range for the reports feature.
- **spina_app.reports_tab_presentation._build_reports_tab._clear_reports_range** (nested_function, lines 98–105, 8 lines, risk `reports`): Handles clear reports range for the reports feature.
- **spina_app.reports_tab_presentation._build_reports_tab._save_reports_page_size** (nested_function, lines 145–152, 8 lines, risk `reports`): Saves save reports page size for the reports feature.
- **spina_app.reports_tab_presentation._build_reports_tab._toggle_reports_notes_panel** (nested_function, lines 252–304, 53 lines, risk `reports`): Handles toggle reports notes panel for the reports feature.

## `spina_app/settings_dialog_presentation.py`

- **spina_app.settings_dialog_presentation.configure_settings_dialog_dependencies** (function, lines 13–18, 6 lines, risk `support`): Handles configure settings dialog dependencies for the settings feature.
- **spina_app.settings_dialog_presentation.open_settings_dialog** (function, lines 22–309, 288 lines, risk `authentication`): App settings (local-only).
- **spina_app.settings_dialog_presentation.open_settings_dialog._browse_reports** (nested_function, lines 88–98, 11 lines, risk `reports`): Handles browse reports for the reports feature.
- **spina_app.settings_dialog_presentation.open_settings_dialog._save_auto_close_setting_only** (nested_function, lines 134–151, 18 lines, risk `support`): Saves save auto close setting only for the settings feature.
- **spina_app.settings_dialog_presentation.open_settings_dialog._run_auto_close_now** (nested_function, lines 153–166, 14 lines, risk `support`): Handles run auto close now for the settings feature.
- **spina_app.settings_dialog_presentation.open_settings_dialog._open_target** (nested_function, lines 215–225, 11 lines, risk `support`): Handles open target for the settings feature.
- **spina_app.settings_dialog_presentation.open_settings_dialog._test_reports** (nested_function, lines 241–254, 14 lines, risk `reports`): Handles test reports for the reports feature.
- **spina_app.settings_dialog_presentation.open_settings_dialog._save** (nested_function, lines 256–291, 36 lines, risk `reports`): Handles save for the settings feature.
...
## `spina_app/system_data_presentation.py`

- **spina_app.system_data_presentation.configure_system_data_presentation_dependencies** (function, lines 7–12, 6 lines, risk `support`): Handles configure system data presentation dependencies for the data bank feature.
- **spina_app.system_data_presentation._build_system_data_tab** (function, lines 25–70, 46 lines, risk `ui_only`): Builds build system data tab for the data bank feature.

## `spina_app/system_data_summary_presentation.py`

- **spina_app.system_data_summary_presentation.configure_system_data_summary_dependencies** (function, lines 7–12, 6 lines, risk `support`): Handles configure system data summary dependencies for the data bank feature.
- **spina_app.system_data_summary_presentation._system_data_get_date** (function, lines 16–34, 19 lines, risk `support`): Handles system data get date for the data bank feature.
- **spina_app.system_data_summary_presentation._system_data_use_focus_date** (function, lines 36–43, 8 lines, risk `support`): Handles system data use focus date for the data bank feature.
- **spina_app.system_data_summary_presentation._system_data_refresh_summary** (function, lines 45–104, 60 lines, risk `support`): Handles system data refresh summary for the data bank feature.
- **spina_app.system_data_summary_presentation._system_data_refresh_summary._fmt_amt** (nested_function, lines 50–57, 8 lines, risk `support`): Handles fmt amt for the data bank feature.
...
## `tools/extract_databank_feature_wave_72.py`

- **tools.extract_databank_feature_wave_72._sha256** (function, lines 43–44, 2 lines, risk `support`): Handles sha256 for the other feature.
- **tools.extract_databank_feature_wave_72._roots** (function, lines 47–56, 10 lines, risk `support`): Handles roots for the other feature.
- **tools.extract_databank_feature_wave_72._final_main_guard** (function, lines 59–72, 14 lines, risk `support`): Handles final main guard for the other feature.
- **tools.extract_databank_feature_wave_72.main** (function, lines 75–176, 102 lines, risk `filesystem`): Handles main for the other feature.

## `tools/extract_databank_feature_wave_72_v2.py`

- **tools.extract_databank_feature_wave_72_v2._dedent_method_source** (function, lines 21–38, 18 lines, risk `support`): Remove the class indent without changing multiline string contents.
- **tools.extract_databank_feature_wave_72_v2.main** (function, lines 41–147, 107 lines, risk `filesystem`): Handles main for the other feature.
...
## `tools/inspect_databank_feature_wave_72.py`

- **tools.inspect_databank_feature_wave_72._sha256** (function, lines 46–47, 2 lines, risk `support`): Handles sha256 for the other feature.
- **tools.inspect_databank_feature_wave_72._root_nodes** (function, lines 50–59, 10 lines, risk `support`): Handles root nodes for the other feature.
- **tools.inspect_databank_feature_wave_72._app_bindings** (function, lines 62–83, 22 lines, risk `support`): Handles app bindings for the other feature.
- **tools.inspect_databank_feature_wave_72._called_names** (function, lines 86–95, 10 lines, risk `support`): Handles called names for the other feature.
- **tools.inspect_databank_feature_wave_72._default_expressions** (function, lines 98–102, 5 lines, risk `support`): Handles default expressions for the other feature.
- **tools.inspect_databank_feature_wave_72._global_name_reads** (function, lines 105–118, 14 lines, risk `support`): Handles global name reads for the other feature.
- **tools.inspect_databank_feature_wave_72.main** (function, lines 121–210, 90 lines, risk `filesystem`): Handles main for the other feature.
...
## `tools/plan_databank_feature_wave_72.py`

- **tools.plan_databank_feature_wave_72._is_databank_symbol** (function, lines 41–51, 11 lines, risk `support`): Handles is databank symbol for the data bank feature.
- **tools.plan_databank_feature_wave_72._binding_value** (function, lines 54–60, 7 lines, risk `support`): Handles binding value for the other feature.
- **tools.plan_databank_feature_wave_72._app_bindings** (function, lines 63–86, 24 lines, risk `support`): Handles app bindings for the other feature.
- **tools.plan_databank_feature_wave_72._source_roots** (function, lines 89–98, 10 lines, risk `support`): Handles source roots for the other feature.
- **tools.plan_databank_feature_wave_72.main** (function, lines 101–249, 149 lines, risk `filesystem`): Handles main for the other feature.
...
## `tools/run_databank_regression_suite_wave_72.py`

- **tools.run_databank_regression_suite_wave_72.main** (function, lines 13–45, 33 lines, risk `reports`): Handles main for the other feature.
...
- **tools.test_backup_history_presentation_wave_68.sha** (function, lines 16–17, 2 lines, risk `filesystem`): Handles sha for the other feature.
- **tools.test_backup_history_presentation_wave_68.dotted** (function, lines 20–32, 13 lines, risk `support`): Handles dotted for the other feature.
- **tools.test_backup_history_presentation_wave_68.main** (function, lines 35–85, 51 lines, risk `filesystem`): Handles main for the other feature.

## `tools/test_backup_history_widget_smoke_wave_68.py`

- **tools.test_backup_history_widget_smoke_wave_68.Dialogs** (class, lines 12–30, 19 lines, risk `container`): Groups Dialogs for the other feature.
- **tools.test_backup_history_widget_smoke_wave_68.Dialogs.__init__** (method, lines 13–17, 5 lines, risk `support`): Handles init for the other feature.
- **tools.test_backup_history_widget_smoke_wave_68.Dialogs.showwarning** (method, lines 19–20, 2 lines, risk `support`): Handles showwarning for the other feature.
- **tools.test_backup_history_widget_smoke_wave_68.Dialogs.showinfo** (method, lines 22–23, 2 lines, risk `support`): Handles showinfo for the other feature.
- **tools.test_backup_history_widget_smoke_wave_68.Dialogs.showerror** (method, lines 25–26, 2 lines, risk `support`): Handles showerror for the other feature.
- **tools.test_backup_history_widget_smoke_wave_68.Dialogs.askyesno** (method, lines 28–30, 3 lines, risk `support`): Handles askyesno for the other feature.
- **tools.test_backup_history_widget_smoke_wave_68.FakeApp** (class, lines 33–75, 43 lines, risk `container`): Groups FakeApp for the other feature.
- **tools.test_backup_history_widget_smoke_wave_68.FakeApp.__init__** (method, lines 34–38, 5 lines, risk `support`): Handles init for the other feature.
- **tools.test_backup_history_widget_smoke_wave_68.FakeApp._list_postgres_backup_files** (method, lines 40–47, 8 lines, risk `backup`): Handles list postgres backup files for the backup feature.
- **tools.test_backup_history_widget_smoke_wave_68.FakeApp._postgres_backup_dir** (method, lines 49–50, 2 lines, risk `backup`): Handles postgres backup dir for the backup feature.
- **tools.test_backup_history_widget_smoke_wave_68.FakeApp._format_bytes** (method, lines 52–53, 2 lines, risk `support`): Handles format bytes for the utilities feature.
- **tools.test_backup_history_widget_smoke_wave_68.FakeApp._verify_postgres_backup_file** (method, lines 55–57, 3 lines, risk `backup`): Handles verify postgres backup file for the backup feature.
- **tools.test_backup_history_widget_smoke_wave_68.FakeApp._restore_backup_to_test_database** (method, lines 59–61, 3 lines, risk `backup`): Handles restore backup to test database for the backup feature.
- **tools.test_backup_history_widget_smoke_wave_68.FakeApp._run_long_task** (method, lines 63–75, 13 lines, risk `support`): Handles run long task for the other feature.
- **tools.test_backup_history_widget_smoke_wave_68.walk** (function, lines 78–81, 4 lines, risk `support`): Handles walk for the other feature.
- **tools.test_backup_history_widget_smoke_wave_68.button** (function, lines 84–88, 5 lines, risk `ui_only`): Handles button for the other feature.
- **tools.test_backup_history_widget_smoke_wave_68.main** (function, lines 91–151, 61 lines, risk `backup`): Handles main for the other feature.
...
## `tools/test_client_new_status_behavior_wave_70.py`

- **tools.test_client_new_status_behavior_wave_70.FakeCursor** (class, lines 15–25, 11 lines, risk `container`): Groups FakeCursor for the database feature.
- **tools.test_client_new_status_behavior_wave_70.FakeCursor.__init__** (method, lines 16–18, 3 lines, risk `support`): Handles init for the database feature.
- **tools.test_client_new_status_behavior_wave_70.FakeCursor.execute** (method, lines 20–22, 3 lines, risk `support`): Handles execute for the database feature.
- **tools.test_client_new_status_behavior_wave_70.FakeCursor.fetchone** (method, lines 24–25, 2 lines, risk `support`): Handles fetchone for the database feature.
- **tools.test_client_new_status_behavior_wave_70.FakeConnection** (class, lines 28–34, 7 lines, risk `container`): Groups FakeConnection for the database feature.
- **tools.test_client_new_status_behavior_wave_70.FakeConnection.__init__** (method, lines 29–31, 3 lines, risk `support`): Handles init for the database feature.
- **tools.test_client_new_status_behavior_wave_70.FakeConnection.cursor** (method, lines 33–34, 2 lines, risk `support`): Handles cursor for the database feature.
- **tools.test_client_new_status_behavior_wave_70.Host** (class, lines 38–54, 17 lines, risk `container`): Groups Host for the other feature.
- **tools.test_client_new_status_behavior_wave_70.Host.__post_init__** (method, lines 43–51, 9 lines, risk `support`): Handles post init for the other feature.
- **tools.test_client_new_status_behavior_wave_70.Host._mode_filter** (method, lines 53–54, 2 lines, risk `support`): Handles mode filter for the other feature.
- **tools.test_client_new_status_behavior_wave_70.call** (function, lines 57–61, 5 lines, risk `support`): Handles call for the other feature.
- **tools.test_client_new_status_behavior_wave_70.main** (function, lines 64–122, 59 lines, risk `reports`): Handles main for the other feature.

## `tools/test_client_new_status_wave_70.py`

- **tools.test_client_new_status_wave_70.signature** (function, lines 18–38, 21 lines, risk `support`): Handles signature for the other feature.
- **tools.test_client_new_status_wave_70.is_final_main_guard** (function, lines 41–47, 7 lines, risk `support`): Handles is final main guard for the other feature.
- **tools.test_client_new_status_wave_70.main** (function, lines 50–108, 59 lines, risk `filesystem`): Handles main for the other feature.
...
## `tools/test_client_statement_generation_behavior_wave_67.py`

- **tools.test_client_statement_generation_behavior_wave_67.MessageboxStub** (class, lines 14–23, 10 lines, risk `container`): Groups MessageboxStub for the other feature.
- **tools.test_client_statement_generation_behavior_wave_67.MessageboxStub.__init__** (method, lines 15–17, 3 lines, risk `support`): Handles init for the other feature.
- **tools.test_client_statement_generation_behavior_wave_67.MessageboxStub.showwarning** (method, lines 19–20, 2 lines, risk `support`): Handles showwarning for the other feature.
- **tools.test_client_statement_generation_behavior_wave_67.MessageboxStub.showerror** (method, lines 22–23, 2 lines, risk `support`): Handles showerror for the other feature.
- **tools.test_client_statement_generation_behavior_wave_67.FakeDB** (class, lines 26–45, 20 lines, risk `container`): Groups FakeDB for the other feature.
- **tools.test_client_statement_generation_behavior_wave_67.FakeDB.__init__** (method, lines 27–29, 3 lines, risk `support`): Handles init for the other feature.
- **tools.test_client_statement_generation_behavior_wave_67.FakeDB.get_client_info** (method, lines 31–38, 8 lines, risk `support`): Retrieves get client info for the clients feature.
- **tools.test_client_statement_generation_behavior_wave_67.FakeDB.get_client_link_meta** (method, lines 40–45, 6 lines, risk `support`): Retrieves get client link meta for the clients feature.
- **tools.test_client_statement_generation_behavior_wave_67.FakeApp** (class, lines 48–73, 26 lines, risk `container`): Groups FakeApp for the other feature.
- **tools.test_client_statement_generation_behavior_wave_67.FakeApp.__init__** (method, lines 49–59, 11 lines, risk `reports`): Handles init for the other feature.
- **tools.test_client_statement_generation_behavior_wave_67.FakeApp._mode_filter** (method, lines 61–62, 2 lines, risk `support`): Handles mode filter for the other feature.
- **tools.test_client_statement_generation_behavior_wave_67.FakeApp._run_long_task** (method, lines 64–73, 10 lines, risk `support`): Handles run long task for the other feature.
- **tools.test_client_statement_generation_behavior_wave_67.safe_component** (function, lines 76–78, 3 lines, risk `support`): Handles safe component for the other feature.
- **tools.test_client_statement_generation_behavior_wave_67.main** (function, lines 81–164, 84 lines, risk `filesystem`): Handles main for the other feature.

## `tools/test_client_statement_generation_wave_67.py`
...
- **tools.test_clients_tab_presentation_wave_55._function_source** (function, lines 13–18, 6 lines, risk `filesystem`): Handles function source for the other feature.
- **tools.test_clients_tab_presentation_wave_55.main** (function, lines 21–40, 20 lines, risk `filesystem`): Handles main for the other feature.

## `tools/test_clients_tab_widget_smoke_wave_55.py`

- **tools.test_clients_tab_widget_smoke_wave_55._Flexible** (class, lines 9–31, 23 lines, risk `container`): Groups Flexible for the other feature.
- **tools.test_clients_tab_widget_smoke_wave_55._Flexible.__init__** (method, lines 10–12, 3 lines, risk `support`): Handles init for the other feature.
- **tools.test_clients_tab_widget_smoke_wave_55._Flexible.__call__** (method, lines 13–23, 11 lines, risk `ui_only`): Handles call for the other feature.
- **tools.test_clients_tab_widget_smoke_wave_55._Flexible.get** (method, lines 24–25, 2 lines, risk `support`): Handles get for the other feature.
- **tools.test_clients_tab_widget_smoke_wave_55._Flexible.set** (method, lines 26–27, 2 lines, risk `support`): Handles set for the other feature.
- **tools.test_clients_tab_widget_smoke_wave_55._Flexible.__iter__** (method, lines 28–29, 2 lines, risk `support`): Handles iter for the other feature.
- **tools.test_clients_tab_widget_smoke_wave_55._Flexible.__bool__** (method, lines 30–31, 2 lines, risk `support`): Handles bool for the other feature.
- **tools.test_clients_tab_widget_smoke_wave_55.DummyApp** (class, lines 34–43, 10 lines, risk `container`): Groups DummyApp for the other feature.
- **tools.test_clients_tab_widget_smoke_wave_55.DummyApp.__init__** (method, lines 35–39, 5 lines, risk `ui_only`): Handles init for the other feature.
- **tools.test_clients_tab_widget_smoke_wave_55.DummyApp.__getattr__** (method, lines 40–43, 4 lines, risk `support`): Handles getattr for the other feature.
- **tools.test_clients_tab_widget_smoke_wave_55._walk** (function, lines 46–49, 4 lines, risk `support`): Handles walk for the other feature.
- **tools.test_clients_tab_widget_smoke_wave_55.main** (function, lines 52–94, 43 lines, risk `reports`): Handles main for the other feature.

## `tools/test_collector_dialog_presentation_wave_43.py`

- **tools.test_collector_dialog_presentation_wave_43.normalized** (function, lines 23–24, 2 lines, risk `support`): Handles normalized for the utilities feature.
- **tools.test_collector_dialog_presentation_wave_43.chain** (function, lines 27–34, 8 lines, risk `support`): Handles chain for the other feature.
- **tools.test_collector_dialog_presentation_wave_43.call_name** (function, lines 37–38, 2 lines, risk `support`): Handles call name for the other feature.
- **tools.test_collector_dialog_presentation_wave_43.source_for** (function, lines 41–42, 2 lines, risk `support`): Handles source for for the other feature.
- **tools.test_collector_dialog_presentation_wave_43.main** (function, lines 45–113, 69 lines, risk `filesystem`): Handles main for the other feature.

## `tools/test_collector_editor_widget_smoke_wave_69.py`

- **tools.test_collector_editor_widget_smoke_wave_69.FakeApp** (class, lines 11–13, 3 lines, risk `container`): Groups FakeApp for the other feature.
- **tools.test_collector_editor_widget_smoke_wave_69.FakeApp.__init__** (method, lines 12–13, 2 lines, risk `support`): Handles init for the other feature.
- **tools.test_collector_editor_widget_smoke_wave_69.colors** (function, lines 16–26, 11 lines, risk `support`): Handles colors for the other feature.
- **tools.test_collector_editor_widget_smoke_wave_69.master_areas** (function, lines 29–30, 2 lines, risk `support`): Handles master areas for the other feature.
- **tools.test_collector_editor_widget_smoke_wave_69.route_button** (function, lines 33–34, 2 lines, risk `ui_only`): Handles route button for the collectors feature.
- **tools.test_collector_editor_widget_smoke_wave_69.all_widgets** (function, lines 37–40, 4 lines, risk `support`): Handles all widgets for the other feature.
- **tools.test_collector_editor_widget_smoke_wave_69.invoke_button** (function, lines 43–51, 9 lines, risk `support`): Handles invoke button for the other feature.
- **tools.test_collector_editor_widget_smoke_wave_69.main** (function, lines 54–89, 36 lines, risk `reports`): Handles main for the other feature.
...
## `tools/test_databank_cell_writes_behavior_wave_61.py`

- **tools.test_databank_cell_writes_behavior_wave_61.FakeEntry** (class, lines 13–22, 10 lines, risk `container`): Groups FakeEntry for the other feature.
- **tools.test_databank_cell_writes_behavior_wave_61.FakeEntry.__init__** (method, lines 14–16, 3 lines, risk `support`): Handles init for the other feature.
- **tools.test_databank_cell_writes_behavior_wave_61.FakeEntry.get** (method, lines 18–19, 2 lines, risk `support`): Handles get for the other feature.
- **tools.test_databank_cell_writes_behavior_wave_61.FakeEntry.destroy** (method, lines 21–22, 2 lines, risk `support`): Handles destroy for the other feature.
- **tools.test_databank_cell_writes_behavior_wave_61.FakeTree** (class, lines 25–36, 12 lines, risk `container`): Groups FakeTree for the other feature.
- **tools.test_databank_cell_writes_behavior_wave_61.FakeTree.__init__** (method, lines 26–27, 2 lines, risk `support`): Handles init for the other feature.
- **tools.test_databank_cell_writes_behavior_wave_61.FakeTree.get_children** (method, lines 29–30, 2 lines, risk `support`): Retrieves get children for the other feature.
- **tools.test_databank_cell_writes_behavior_wave_61.FakeTree.set** (method, lines 32–36, 5 lines, risk `support`): Handles set for the other feature.
- **tools.test_databank_cell_writes_behavior_wave_61.FakeDB** (class, lines 39–60, 22 lines, risk `container`): Groups FakeDB for the other feature.
- **tools.test_databank_cell_writes_behavior_wave_61.FakeDB.__init__** (method, lines 40–46, 7 lines, risk `support`): Handles init for the other feature.
- **tools.test_databank_cell_writes_behavior_wave_61.FakeDB.get_transaction** (method, lines 48–50, 3 lines, risk `support`): Retrieves get transaction for the payments feature.
- **tools.test_databank_cell_writes_behavior_wave_61.FakeDB.add_or_update_transaction** (method, lines 52–55, 4 lines, risk `support`): Handles add or update transaction for the payments feature.
- **tools.test_databank_cell_writes_behavior_wave_61.FakeDB.delete_transaction** (method, lines 57–60, 4 lines, risk `support`): Removes delete transaction for the payments feature.
- **tools.test_databank_cell_writes_behavior_wave_61.FakeApp** (class, lines 63–89, 27 lines, risk `container`): Groups FakeApp for the other feature.
- **tools.test_databank_cell_writes_behavior_wave_61.FakeApp.__init__** (method, lines 64–76, 13 lines, risk `support`): Handles init for the other feature.
- **tools.test_databank_cell_writes_behavior_wave_61.FakeApp.refresh_data_grid** (method, lines 78–79, 2 lines, risk `support`): Refreshes refresh data grid for the data bank feature.
- **tools.test_databank_cell_writes_behavior_wave_61.FakeApp._update_data_toolbar** (method, lines 81–82, 2 lines, risk `support`): Updates update data toolbar for the navigation feature.
- **tools.test_databank_cell_writes_behavior_wave_61.FakeApp._pick_missed_reason** (method, lines 84–86, 3 lines, risk `support`): Handles pick missed reason for the payments feature.
- **tools.test_databank_cell_writes_behavior_wave_61.FakeApp._mode_filter** (method, lines 88–89, 2 lines, risk `support`): Handles mode filter for the other feature.
- **tools.test_databank_cell_writes_behavior_wave_61.main** (function, lines 92–173, 82 lines, risk `reports`): Handles main for the other feature.

## `tools/test_databank_cell_writes_wave_61.py`

- **tools.test_databank_cell_writes_wave_61.sha** (function, lines 18–19, 2 lines, risk `filesystem`): Handles sha for the other feature.
- **tools.test_databank_cell_writes_wave_61.dotted** (function, lines 22–28, 7 lines, risk `support`): Handles dotted for the other feature.
- **tools.test_databank_cell_writes_wave_61.main** (function, lines 31–90, 60 lines, risk `filesystem`): Handles main for the other feature.

## `tools/test_databank_close_history_presentation_wave_57.py`

- **tools.test_databank_close_history_presentation_wave_57.main** (function, lines 13–42, 30 lines, risk `filesystem`): Handles main for the other feature.

## `tools/test_databank_close_history_widget_smoke_wave_57.py`

- **tools.test_databank_close_history_widget_smoke_wave_57.FakeDB** (class, lines 10–28, 19 lines, risk `container`): Groups FakeDB for the other feature.
- **tools.test_databank_close_history_widget_smoke_wave_57.FakeDB.__init__** (method, lines 11–12, 2 lines, risk `support`): Handles init for the other feature.
- **tools.test_databank_close_history_widget_smoke_wave_57.FakeDB.list_databank_day_close_history** (method, lines 14–28, 15 lines, risk `support`): Handles list databank day close history for the data bank feature.
- **tools.test_databank_close_history_widget_smoke_wave_57.FakeApp** (class, lines 31–34, 4 lines, risk `container`): Groups FakeApp for the other feature.
- **tools.test_databank_close_history_widget_smoke_wave_57.FakeApp.__init__** (method, lines 32–34, 3 lines, risk `support`): Handles init for the other feature.
- **tools.test_databank_close_history_widget_smoke_wave_57.walk** (function, lines 37–40, 4 lines, risk `support`): Handles walk for the other feature.
- **tools.test_databank_close_history_widget_smoke_wave_57.main** (function, lines 43–93, 51 lines, risk `reports`): Handles main for the other feature.

## `tools/test_databank_close_records_presentation_wave_66.py`

- **tools.test_databank_close_records_presentation_wave_66.sha** (function, lines 17–18, 2 lines, risk `filesystem`): Handles sha for the other feature.
- **tools.test_databank_close_records_presentation_wave_66.dotted** (function, lines 21–33, 13 lines, risk `support`): Handles dotted for the other feature.
- **tools.test_databank_close_records_presentation_wave_66.top_level_functions** (function, lines 36–43, 8 lines, risk `filesystem`): Handles top level functions for the other feature.
- **tools.test_databank_close_records_presentation_wave_66.main** (function, lines 46–90, 45 lines, risk `filesystem`): Handles main for the other feature.

## `tools/test_databank_close_records_widget_smoke_wave_66.py`

- **tools.test_databank_close_records_widget_smoke_wave_66.FakeDB** (class, lines 10–43, 34 lines, risk `container`): Groups FakeDB for the other feature.
- **tools.test_databank_close_records_widget_smoke_wave_66.FakeDB.__init__** (method, lines 11–12, 2 lines, risk `support`): Handles init for the other feature.
- **tools.test_databank_close_records_widget_smoke_wave_66.FakeDB.list_databank_day_close_records** (method, lines 14–43, 30 lines, risk `support`): Handles list databank day close records for the data bank feature.
- **tools.test_databank_close_records_widget_smoke_wave_66.FakeApp** (class, lines 46–60, 15 lines, risk `container`): Groups FakeApp for the other feature.
- **tools.test_databank_close_records_widget_smoke_wave_66.FakeApp.__init__** (method, lines 47–51, 5 lines, risk `support`): Handles init for the other feature.
- **tools.test_databank_close_records_widget_smoke_wave_66.FakeApp._get_databank_focus_date** (method, lines 53–54, 2 lines, risk `support`): Retrieves get databank focus date for the data bank feature.
- **tools.test_databank_close_records_widget_smoke_wave_66.FakeApp.open_databank_close_dialog** (method, lines 56–57, 2 lines, risk `support`): Handles open databank close dialog for the data bank feature.
- **tools.test_databank_close_records_widget_smoke_wave_66.FakeApp.print_databank_close_report** (method, lines 59–60, 2 lines, risk `reports`): Generates print databank close report for the data bank feature.
- **tools.test_databank_close_records_widget_smoke_wave_66.walk** (function, lines 63–66, 4 lines, risk `support`): Handles walk for the other feature.
- **tools.test_databank_close_records_widget_smoke_wave_66.widget_by_text** (function, lines 69–73, 5 lines, risk `support`): Handles widget by text for the other feature.
- **tools.test_databank_close_records_widget_smoke_wave_66.main** (function, lines 76–129, 54 lines, risk `reports`): Handles main for the other feature.

## `tools/test_databank_delete_day_behavior_wave_62.py`

- **tools.test_databank_delete_day_behavior_wave_62.FakeCursor** (class, lines 14–25, 12 lines, risk `container`): Groups FakeCursor for the database feature.
- **tools.test_databank_delete_day_behavior_wave_62.FakeCursor.__init__** (method, lines 15–16, 2 lines, risk `support`): Handles init for the database feature.
- **tools.test_databank_delete_day_behavior_wave_62.FakeCursor.execute** (method, lines 18–22, 5 lines, risk `support`): Handles execute for the database feature.
- **tools.test_databank_delete_day_behavior_wave_62.FakeCursor.fetchone** (method, lines 24–25, 2 lines, risk `support`): Handles fetchone for the database feature.
- **tools.test_databank_delete_day_behavior_wave_62.FakeConn** (class, lines 28–33, 6 lines, risk `container`): Groups FakeConn for the other feature.
- **tools.test_databank_delete_day_behavior_wave_62.FakeConn.__init__** (method, lines 29–30, 2 lines, risk `support`): Handles init for the other feature.
- **tools.test_databank_delete_day_behavior_wave_62.FakeConn.cursor** (method, lines 32–33, 2 lines, risk `support`): Handles cursor for the database feature.
- **tools.test_databank_delete_day_behavior_wave_62.FakeDB** (class, lines 36–56, 21 lines, risk `container`): Groups FakeDB for the other feature.
- **tools.test_databank_delete_day_behavior_wave_62.FakeDB.__init__** (method, lines 37–46, 10 lines, risk `support`): Handles init for the other feature.
- **tools.test_databank_delete_day_behavior_wave_62.FakeDB.get_databank_day_close** (method, lines 48–50, 3 lines, risk `support`): Retrieves get databank day close for the data bank feature.
- **tools.test_databank_delete_day_behavior_wave_62.FakeDB.delete_transactions_for_day** (method, lines 52–56, 5 lines, risk `support`): Removes delete transactions for day for the payments feature.
- **tools.test_databank_delete_day_behavior_wave_62.FakeApp** (class, lines 59–84, 26 lines, risk `container`): Groups FakeApp for the other feature.
- **tools.test_databank_delete_day_behavior_wave_62.FakeApp.__init__** (method, lines 60–71, 12 lines, risk `support`): Handles init for the other feature.
- **tools.test_databank_delete_day_behavior_wave_62.FakeApp._prompt_current_password** (method, lines 73–75, 3 lines, risk `authentication`): Handles prompt current password for the payments feature.
- **tools.test_databank_delete_day_behavior_wave_62.FakeApp.refresh_data_grid** (method, lines 77–78, 2 lines, risk `support`): Refreshes refresh data grid for the data bank feature.
- **tools.test_databank_delete_day_behavior_wave_62.FakeApp.refresh_reports** (method, lines 80–81, 2 lines, risk `reports`): Refreshes refresh reports for the reports feature.
...
- **tools.test_databank_editor_presentation_wave_60._norm** (function, lines 24–25, 2 lines, risk `filesystem`): Handles norm for the other feature.
- **tools.test_databank_editor_presentation_wave_60._source_map** (function, lines 28–39, 12 lines, risk `support`): Handles source map for the other feature.
- **tools.test_databank_editor_presentation_wave_60._module_metadata** (function, lines 42–47, 6 lines, risk `support`): Handles module metadata for the other feature.
- **tools.test_databank_editor_presentation_wave_60.main** (function, lines 50–105, 56 lines, risk `reports`): Handles main for the other feature.

## `tools/test_databank_editor_widget_smoke_wave_60.py`

- **tools.test_databank_editor_widget_smoke_wave_60.StubApp** (class, lines 16–17, 2 lines, risk `container`): Groups StubApp for the other feature.
- **tools.test_databank_editor_widget_smoke_wave_60._button_texts** (function, lines 20–29, 10 lines, risk `ui_only`): Handles button texts for the other feature.
- **tools.test_databank_editor_widget_smoke_wave_60.test_missed_reason_dialog** (function, lines 32–59, 28 lines, risk `ui_only`): Handles test missed reason dialog for the payments feature.
- **tools.test_databank_editor_widget_smoke_wave_60.test_inline_editor** (function, lines 62–114, 53 lines, risk `ui_only`): Handles test inline editor for the other feature.
- **tools.test_databank_editor_widget_smoke_wave_60.main** (function, lines 117–127, 11 lines, risk `reports`): Handles main for the other feature.

## `tools/test_databank_feature_wave_72.py`

- **tools.test_databank_feature_wave_72._sha256** (function, lines 60–61, 2 lines, risk `support`): Handles sha256 for the other feature.
- **tools.test_databank_feature_wave_72._top_functions** (function, lines 64–69, 6 lines, risk `support`): Handles top functions for the other feature.
- **tools.test_databank_feature_wave_72.main** (function, lines 72–113, 42 lines, risk `filesystem`): Handles main for the other feature.

## `tools/test_databank_grid_presentation_wave_59.py`

- **tools.test_databank_grid_presentation_wave_59.dotted** (function, lines 47–54, 8 lines, risk `support`): Handles dotted for the other feature.
- **tools.test_databank_grid_presentation_wave_59.function_names** (function, lines 57–65, 9 lines, risk `filesystem`): Handles function names for the other feature.
- **tools.test_databank_grid_presentation_wave_59.main** (function, lines 68–112, 45 lines, risk `filesystem`): Handles main for the other feature.

## `tools/test_databank_grid_widget_smoke_wave_59.py`

- **tools.test_databank_grid_widget_smoke_wave_59.FixedDate** (class, lines 12–15, 4 lines, risk `container`): Groups FixedDate for the other feature.
- **tools.test_databank_grid_widget_smoke_wave_59.FixedDate.today** (method, lines 14–15, 2 lines, risk `support`): Handles today for the other feature.
- **tools.test_databank_grid_widget_smoke_wave_59.FakeDB** (class, lines 18–39, 22 lines, risk `container`): Groups FakeDB for the other feature.
- **tools.test_databank_grid_widget_smoke_wave_59.FakeDB.__init__** (method, lines 19–20, 2 lines, risk `support`): Handles init for the other feature.
- **tools.test_databank_grid_widget_smoke_wave_59.FakeDB.get_all_clients** (method, lines 22–27, 6 lines, risk `support`): Retrieves get all clients for the clients feature.
- **tools.test_databank_grid_widget_smoke_wave_59.FakeDB.get_client_info** (method, lines 29–31, 3 lines, risk `support`): Retrieves get client info for the clients feature.
- **tools.test_databank_grid_widget_smoke_wave_59.FakeDB.get_transaction** (method, lines 33–39, 7 lines, risk `support`): Retrieves get transaction for the payments feature.
- **tools.test_databank_grid_widget_smoke_wave_59.FakeApp** (class, lines 42–96, 55 lines, risk `container`): Groups FakeApp for the other feature.
- **tools.test_databank_grid_widget_smoke_wave_59.FakeApp.__init__** (method, lines 48–62, 15 lines, risk `ui_only`): Handles init for the other feature.
- **tools.test_databank_grid_widget_smoke_wave_59.FakeApp._configure_tree_stripes** (method, lines 64–66, 3 lines, risk `ui_only`): Handles configure tree stripes for the other feature.
- **tools.test_databank_grid_widget_smoke_wave_59.FakeApp._ensure_databank_edit_bindings** (method, lines 68–69, 2 lines, risk `support`): Handles ensure databank edit bindings for the data bank feature.
- **tools.test_databank_grid_widget_smoke_wave_59.FakeApp._mode_filter** (method, lines 71–72, 2 lines, risk `support`): Handles mode filter for the other feature.
- **tools.test_databank_grid_widget_smoke_wave_59.FakeApp._month_label** (method, lines 74–75, 2 lines, risk `support`): Handles month label for the navigation feature.
- **tools.test_databank_grid_widget_smoke_wave_59.FakeApp._remember_cell_click** (method, lines 77–78, 2 lines, risk `support`): Handles remember cell click for the other feature.
- **tools.test_databank_grid_widget_smoke_wave_59.FakeApp._resize_databank_columns** (method, lines 80–81, 2 lines, risk `support`): Handles resize databank columns for the data bank feature.
- **tools.test_databank_grid_widget_smoke_wave_59.FakeApp._update_data_toolbar** (method, lines 83–84, 2 lines, risk `support`): Updates update data toolbar for the navigation feature.
- **tools.test_databank_grid_widget_smoke_wave_59.FakeApp._begin_cell_edit** (method, lines 86–87, 2 lines, risk `support`): Handles begin cell edit for the data bank feature.
- **tools.test_databank_grid_widget_smoke_wave_59.FakeApp.delete_selected_cell** (method, lines 89–90, 2 lines, risk `support`): Removes delete selected cell for the data bank feature.
- **tools.test_databank_grid_widget_smoke_wave_59.FakeApp._on_mousewheel_sync** (method, lines 92–93, 2 lines, risk `support`): Handles on mousewheel sync for the navigation feature.
- **tools.test_databank_grid_widget_smoke_wave_59.FakeApp._mark_missed_for_selected** (method, lines 95–96, 2 lines, risk `support`): Handles mark missed for selected for the other feature.
- **tools.test_databank_grid_widget_smoke_wave_59.main** (function, lines 99–145, 47 lines, risk `reports`): Handles main for the other feature.
...
## `tools/test_legacy_area_manager_cleanup_wave_71.py`

- **tools.test_legacy_area_manager_cleanup_wave_71.signature** (function, lines 18–38, 21 lines, risk `support`): Handles signature for the other feature.
- **tools.test_legacy_area_manager_cleanup_wave_71.ast_sha** (function, lines 41–43, 3 lines, risk `support`): Handles ast sha for the other feature.
- **tools.test_legacy_area_manager_cleanup_wave_71.is_main_guard** (function, lines 46–54, 9 lines, risk `support`): Handles is main guard for the other feature.
- **tools.test_legacy_area_manager_cleanup_wave_71.main** (function, lines 57–116, 60 lines, risk `filesystem`): Handles main for the other feature.
...
## `tools/test_legacy_collector_editor_cleanup_wave_69.py`

- **tools.test_legacy_collector_editor_cleanup_wave_69.main** (function, lines 17–64, 48 lines, risk `filesystem`): Handles main for the other feature.
...
## `tools/test_reports_tab_presentation_wave_64.py`

- **tools.test_reports_tab_presentation_wave_64.sha** (function, lines 14–15, 2 lines, risk `filesystem`): Handles sha for the other feature.
- **tools.test_reports_tab_presentation_wave_64.dotted** (function, lines 18–30, 13 lines, risk `support`): Handles dotted for the other feature.
- **tools.test_reports_tab_presentation_wave_64.main** (function, lines 33–62, 30 lines, risk `filesystem`): Handles main for the other feature.

## `tools/test_reports_tab_widget_smoke_wave_64.py`

- **tools.test_reports_tab_widget_smoke_wave_64.FakeApp** (class, lines 10–46, 37 lines, risk `container`): Groups FakeApp for the other feature.
- **tools.test_reports_tab_widget_smoke_wave_64.FakeApp.__init__** (method, lines 11–15, 5 lines, risk `reports`): Handles init for the other feature.
- **tools.test_reports_tab_widget_smoke_wave_64.FakeApp.refresh_reports** (method, lines 17–18, 2 lines, risk `reports`): Refreshes refresh reports for the reports feature.
- **tools.test_reports_tab_widget_smoke_wave_64.FakeApp.generate_pdf_selected** (method, lines 20–21, 2 lines, risk `reports`): Generates generate pdf selected for the reports feature.
- **tools.test_reports_tab_widget_smoke_wave_64.FakeApp.open_report_generation_log** (method, lines 23–24, 2 lines, risk `reports`): Handles open report generation log for the reports feature.
- **tools.test_reports_tab_widget_smoke_wave_64.FakeApp._open_note_dialog** (method, lines 26–27, 2 lines, risk `support`): Handles open note dialog for the notes feature.
- **tools.test_reports_tab_widget_smoke_wave_64.FakeApp._auto_load_report_note** (method, lines 29–30, 2 lines, risk `reports`): Handles auto load report note for the reports feature.
- **tools.test_reports_tab_widget_smoke_wave_64.FakeApp._configure_tree_stripes** (method, lines 32–34, 3 lines, risk `ui_only`): Handles configure tree stripes for the other feature.
- **tools.test_reports_tab_widget_smoke_wave_64.FakeApp._load_report_note_for_client** (method, lines 36–37, 2 lines, risk `reports`): Loads load report note for client for the clients feature.
- **tools.test_reports_tab_widget_smoke_wave_64.FakeApp._save_dated_note_for_client** (method, lines 39–40, 2 lines, risk `support`): Saves save dated note for client for the clients feature.
- **tools.test_reports_tab_widget_smoke_wave_64.FakeApp._save_report_note_for_client** (method, lines 42–43, 2 lines, risk `reports`): Saves save report note for client for the clients feature.
- **tools.test_reports_tab_widget_smoke_wave_64.FakeApp._set_report_note_text** (method, lines 45–46, 2 lines, risk `reports`): Updates set report note text for the reports feature.
- **tools.test_reports_tab_widget_smoke_wave_64.walk** (function, lines 49–52, 4 lines, risk `support`): Handles walk for the other feature.
- **tools.test_reports_tab_widget_smoke_wave_64.button** (function, lines 55–59, 5 lines, risk `ui_only`): Handles button for the other feature.
- **tools.test_reports_tab_widget_smoke_wave_64.main** (function, lines 62–115, 54 lines, risk `reports`): Handles main for the other feature.

## `tools/test_settings_dialog_presentation_wave_65.py`

- **tools.test_settings_dialog_presentation_wave_65.sha** (function, lines 14–15, 2 lines, risk `filesystem`): Handles sha for the other feature.
- **tools.test_settings_dialog_presentation_wave_65.dotted** (function, lines 18–30, 13 lines, risk `support`): Handles dotted for the other feature.
- **tools.test_settings_dialog_presentation_wave_65.main** (function, lines 33–72, 40 lines, risk `filesystem`): Handles main for the other feature.

## `tools/test_settings_dialog_widget_smoke_wave_65.py`

- **tools.test_settings_dialog_widget_smoke_wave_65.FakeApp** (class, lines 11–24, 14 lines, risk `container`): Groups FakeApp for the other feature.
- **tools.test_settings_dialog_widget_smoke_wave_65.FakeApp.__init__** (method, lines 12–15, 4 lines, risk `support`): Handles init for the other feature.
- **tools.test_settings_dialog_widget_smoke_wave_65.FakeApp.set_theme** (method, lines 17–18, 2 lines, risk `support`): Updates set theme for the settings feature.
- **tools.test_settings_dialog_widget_smoke_wave_65.FakeApp._users_db_path** (method, lines 20–21, 2 lines, risk `authentication`): Handles users db path for the authentication feature.
- **tools.test_settings_dialog_widget_smoke_wave_65.FakeApp.run_auto_daily_close** (method, lines 23–24, 2 lines, risk `support`): Handles run auto daily close for the other feature.
- **tools.test_settings_dialog_widget_smoke_wave_65.walk** (function, lines 27–30, 4 lines, risk `support`): Handles walk for the other feature.
- **tools.test_settings_dialog_widget_smoke_wave_65.widget_by_text** (function, lines 33–37, 5 lines, risk `support`): Handles widget by text for the other feature.
- **tools.test_settings_dialog_widget_smoke_wave_65.main** (function, lines 40–164, 125 lines, risk `reports`): Handles main for the other feature.
- **tools.test_settings_dialog_widget_smoke_wave_65.main.load_settings** (nested_function, lines 53–54, 2 lines, risk `support`): Loads load settings for the settings feature.
- **tools.test_settings_dialog_widget_smoke_wave_65.main.save_settings** (nested_function, lines 56–60, 5 lines, risk `support`): Saves save settings for the settings feature.
- **tools.test_settings_dialog_widget_smoke_wave_65.main.open_path** (nested_function, lines 62–64, 3 lines, risk `support`): Handles open path for the utilities feature.
...
## `tools/test_system_data_presentation_wave_56.py`

- **tools.test_system_data_presentation_wave_56.main** (function, lines 14–38, 25 lines, risk `filesystem`): Handles main for the other feature.

## `tools/test_system_data_summary_presentation_wave_58.py`

- **tools.test_system_data_summary_presentation_wave_58.dotted** (function, lines 15–22, 8 lines, risk `support`): Handles dotted for the other feature.
- **tools.test_system_data_summary_presentation_wave_58.main** (function, lines 25–51, 27 lines, risk `filesystem`): Handles main for the other feature.

## `tools/test_system_data_summary_widget_smoke_wave_58.py`

- **tools.test_system_data_summary_widget_smoke_wave_58.FakeDB** (class, lines 9–28, 20 lines, risk `container`): Groups FakeDB for the other feature.
- **tools.test_system_data_summary_widget_smoke_wave_58.FakeDB.__init__** (method, lines 10–20, 11 lines, risk `support`): Handles init for the other feature.
- **tools.test_system_data_summary_widget_smoke_wave_58.FakeDB.get_databank_daily_total** (method, lines 22–24, 3 lines, risk `support`): Retrieves get databank daily total for the data bank feature.
- **tools.test_system_data_summary_widget_smoke_wave_58.FakeDB.get_databank_day_close** (method, lines 26–28, 3 lines, risk `support`): Retrieves get databank day close for the data bank feature.
- **tools.test_system_data_summary_widget_smoke_wave_58.FakeApp** (class, lines 31–43, 13 lines, risk `container`): Groups FakeApp for the other feature.
- **tools.test_system_data_summary_widget_smoke_wave_58.FakeApp.__init__** (method, lines 36–40, 5 lines, risk `ui_only`): Handles init for the other feature.
- **tools.test_system_data_summary_widget_smoke_wave_58.FakeApp._get_databank_focus_date** (method, lines 42–43, 2 lines, risk `support`): Retrieves get databank focus date for the data bank feature.
- **tools.test_system_data_summary_widget_smoke_wave_58.main** (function, lines 46–94, 49 lines, risk `reports`): Handles main for the other feature.

## `tools/test_system_data_widget_smoke_wave_56.py`

- **tools.test_system_data_widget_smoke_wave_56.walk** (function, lines 11–14, 4 lines, risk `support`): Handles walk for the other feature.
- **tools.test_system_data_widget_smoke_wave_56.FakeApp** (class, lines 17–32, 16 lines, risk `container`): Groups FakeApp for the other feature.
- **tools.test_system_data_widget_smoke_wave_56.FakeApp.__init__** (method, lines 18–22, 5 lines, risk `ui_only`): Handles init for the other feature.
- **tools.test_system_data_widget_smoke_wave_56.FakeApp.__getattr__** (method, lines 24–32, 9 lines, risk `support`): Handles getattr for the other feature.
- **tools.test_system_data_widget_smoke_wave_56.main** (function, lines 35–61, 27 lines, risk `reports`): Handles main for the other feature.
...
## `wave72_databank_sources/App___build_databank_collector_defaults_for_date.py`

- **wave72_databank_sources.App___build_databank_collector_defaults_for_date._build_databank_collector_defaults_for_date** (function, lines 1–70, 70 lines, risk `database_read`): Builds build databank collector defaults for date for the collectors feature.
- **wave72_databank_sources.App___build_databank_collector_defaults_for_date._build_databank_collector_defaults_for_date._norm_area** (nested_function, lines 2–6, 5 lines, risk `support`): Handles norm area for the collectors feature.

## `wave72_databank_sources/App___clear_preview.py`

- **wave72_databank_sources.App___clear_preview._clear_preview** (function, lines 1–3, 3 lines, risk `support`): Handles clear preview for the data bank feature.

## `wave72_databank_sources/App___get_databank_focus_date.py`

- **wave72_databank_sources.App___get_databank_focus_date._get_databank_focus_date** (function, lines 1–23, 23 lines, risk `support`): Retrieves get databank focus date for the data bank feature.

## `wave72_databank_sources/App___hide_system_data_tab.py`

- **wave72_databank_sources.App___hide_system_data_tab._hide_system_data_tab** (function, lines 1–6, 6 lines, risk `support`): Handles hide system data tab for the data bank feature.

## `wave72_databank_sources/App___import_encoder_batch.py`

- **wave72_databank_sources.App___import_encoder_batch._import_encoder_batch** (function, lines 1–420, 420 lines, risk `filesystem`): Import One-Day Encoder exports (.jsonl or .csv) into the DB. - Dedupe by record_id (preferred) or a content hash fallback - Unknown clients are skipped (no auto-create) - Advances are stored via description tag: [ADV:s..e; s..e; ...] (supports multiple ranges)
- **wave72_databank_sources.App___import_encoder_batch._import_encoder_batch._canon_lt** (nested_function, lines 22–26, 5 lines, risk `filesystem`): Handles canon lt for the other feature.
- **wave72_databank_sources.App___import_encoder_batch._import_encoder_batch._is_date** (nested_function, lines 28–30, 3 lines, risk `support`): Handles is date for the other feature.
- **wave72_databank_sources.App___import_encoder_batch._import_encoder_batch._adv_tag_from_ranges** (nested_function, lines 32–45, 14 lines, risk `support`): Handles adv tag from ranges for the other feature.
- **wave72_databank_sources.App___import_encoder_batch._import_encoder_batch._ilog** (nested_function, lines 94–98, 5 lines, risk `support`): Handles ilog for the other feature.

## `wave72_databank_sources/App___import_from_excel_core.py`

- **wave72_databank_sources.App___import_from_excel_core._import_from_excel_core** (function, lines 1–166, 166 lines, risk `database_read`): Auto-detect payments and reasons from Excel. Rules: " First row = headers. Must include 'Client Name' and at least one date column. " A date column can be an Excel date/datetime or a string 'YYYY-MM-DD'. " If a cell under a date column is numeric (or numeric-looking text): that's the amount. " If a 
- **wave72_databank_sources.App___import_from_excel_core._import_from_excel_core._parse_date_header** (nested_function, lines 20–31, 12 lines, risk `support`): Handles parse date header for the utilities feature.
- **wave72_databank_sources.App___import_from_excel_core._import_from_excel_core._to_number** (nested_function, lines 33–49, 17 lines, risk `filesystem`): Handles to number for the data bank feature.
- **wave72_databank_sources.App___import_from_excel_core._import_from_excel_core._is_text_reason** (nested_function, lines 51–58, 8 lines, risk `support`): Handles is text reason for the data bank feature.

## `wave72_databank_sources/App___import_from_excel_entry.py`

- **wave72_databank_sources.App___import_from_excel_entry._import_from_excel_entry** (function, lines 1–42, 42 lines, risk `support`): Import payments from Excel. Supports: 1) Date-grid templates (first row has 'Client Name' + date columns like YYYY-MM-DD) via _import_from_excel_core() 2) One-day Daily Collection templates (Client | Payment | Reason), optionally grouped by [AREA] rows Notes: - Unknown clients are skipped (to avoid 

## `wave72_databank_sources/App___import_from_excel_entry_worker.py`

- **wave72_databank_sources.App___import_from_excel_entry_worker._import_from_excel_entry_worker** (function, lines 1–397, 397 lines, risk `support`): Worker for _import_from_excel_entry (runs off the Tk main thread).
- **wave72_databank_sources.App___import_from_excel_entry_worker._import_from_excel_entry_worker._norm** (nested_function, lines 60–62, 3 lines, risk `filesystem`): Handles norm for the data bank feature.
- **wave72_databank_sources.App___import_from_excel_entry_worker._import_from_excel_entry_worker._looks_like_date_header** (nested_function, lines 64–76, 13 lines, risk `support`): Handles looks like date header for the data bank feature.
- **wave72_databank_sources.App___import_from_excel_entry_worker._import_from_excel_entry_worker._parse_sheet** (nested_function, lines 175–308, 134 lines, risk `filesystem`): Handles parse sheet for the utilities feature.

## `wave72_databank_sources/App___load_collectors_route_map.py`

- **wave72_databank_sources.App___load_collectors_route_map._load_collectors_route_map** (function, lines 1–40, 40 lines, risk `filesystem`): Loads load collectors route map for the collectors feature.

## `wave72_databank_sources/App___show_system_data_tab.py`

- **wave72_databank_sources.App___show_system_data_tab._show_system_data_tab** (function, lines 1–10, 10 lines, risk `support`): Handles show system data tab for the data bank feature.

## `wave72_databank_sources/App___start_edit.py`

- **wave72_databank_sources.App___start_edit._start_edit** (function, lines 1–71, 71 lines, risk `filesystem`): Handles start edit for the other feature.
- **wave72_databank_sources.App___start_edit._start_edit.save** (nested_function, lines 22–60, 39 lines, risk `ui_only`): Handles save for the other feature.
- **wave72_databank_sources.App___start_edit._start_edit._close_editor** (nested_function, lines 62–67, 6 lines, risk `support`): Handles close editor for the other feature.

## `wave72_databank_sources/App___system_data_open_close.py`

- **wave72_databank_sources.App___system_data_open_close._system_data_open_close** (function, lines 1–11, 11 lines, risk `support`): Handles system data open close for the data bank feature.

## `wave72_databank_sources/App___system_data_open_history.py`

- **wave72_databank_sources.App___system_data_open_history._system_data_open_history** (function, lines 1–5, 5 lines, risk `support`): Handles system data open history for the data bank feature.

## `wave72_databank_sources/App___system_data_open_records.py`

- **wave72_databank_sources.App___system_data_open_records._system_data_open_records** (function, lines 1–5, 5 lines, risk `support`): Handles system data open records for the data bank feature.

## `wave72_databank_sources/App___system_data_print_report.py`

- **wave72_databank_sources.App___system_data_print_report._system_data_print_report** (function, lines 1–5, 5 lines, risk `reports`): Handles system data print report for the data bank feature.

## `wave72_databank_sources/App__on_day_double.py`

- **wave72_databank_sources.App__on_day_double.on_day_double** (function, lines 1–76, 76 lines, risk `filesystem`): Handles on day double for the other feature.
- **wave72_databank_sources.App__on_day_double.on_day_double.save** (nested_function, lines 25–64, 40 lines, risk `ui_only`): Handles save for the other feature.
- **wave72_databank_sources.App__on_day_double.on_day_double._close_editor** (nested_function, lines 67–72, 6 lines, risk `support`): Handles close editor for the other feature.

## `wave72_databank_sources/App__open_databank_close_dialog.py`

- **wave72_databank_sources.App__open_databank_close_dialog.open_databank_close_dialog** (function, lines 1–651, 651 lines, risk `reports`): Handles open databank close dialog for the data bank feature.
- **wave72_databank_sources.App__open_databank_close_dialog.open_databank_close_dialog._parse_amount** (nested_function, lines 52–57, 6 lines, risk `filesystem`): Handles parse amount for the utilities feature.
- **wave72_databank_sources.App__open_databank_close_dialog.open_databank_close_dialog._fmt_amount** (nested_function, lines 59–66, 8 lines, risk `support`): Handles fmt amount for the data bank feature.
- **wave72_databank_sources.App__open_databank_close_dialog.open_databank_close_dialog._variance_status** (nested_function, lines 68–75, 8 lines, risk `support`): Handles variance status for the data bank feature.
- **wave72_databank_sources.App__open_databank_close_dialog.open_databank_close_dialog._default_workflow** (nested_function, lines 77–82, 6 lines, risk `support`): Handles default workflow for the data bank feature.
- **wave72_databank_sources.App__open_databank_close_dialog.open_databank_close_dialog._selected_split_index** (nested_function, lines 179–186, 8 lines, risk `support`): Handles selected split index for the data bank feature.
- **wave72_databank_sources.App__open_databank_close_dialog.open_databank_close_dialog._clear_split_editor** (nested_function, lines 188–193, 6 lines, risk `support`): Handles clear split editor for the data bank feature.
- **wave72_databank_sources.App__open_databank_close_dialog.open_databank_close_dialog._refresh_split_tree** (nested_function, lines 195–242, 48 lines, risk `ui_only`): Refreshes refresh split tree for the data bank feature.
- **wave72_databank_sources.App__open_databank_close_dialog.open_databank_close_dialog._load_split_editor_from_selection** (nested_function, lines 244–256, 13 lines, risk `support`): Loads load split editor from selection for the data bank feature.
- **wave72_databank_sources.App__open_databank_close_dialog.open_databank_close_dialog._upsert_split_row** (nested_function, lines 258–289, 32 lines, risk `support`): Handles upsert split row for the data bank feature.
- **wave72_databank_sources.App__open_databank_close_dialog.open_databank_close_dialog._remove_split_row** (nested_function, lines 291–311, 21 lines, risk `support`): Removes remove split row for the data bank feature.
- **wave72_databank_sources.App__open_databank_close_dialog.open_databank_close_dialog._load_route_collectors** (nested_function, lines 313–325, 13 lines, risk `support`): Loads load route collectors for the collectors feature.
- **wave72_databank_sources.App__open_databank_close_dialog.open_databank_close_dialog._save_split** (nested_function, lines 327–345, 19 lines, risk `support`): Saves save split for the data bank feature.
- **wave72_databank_sources.App__open_databank_close_dialog.open_databank_close_dialog._apply_mode** (nested_function, lines 347–386, 40 lines, risk `ui_only`): Handles apply mode for the data bank feature.
- **wave72_databank_sources.App__open_databank_close_dialog.open_databank_close_dialog._recalc** (nested_function, lines 388–410, 23 lines, risk `support`): Handles recalc for the data bank feature.
- **wave72_databank_sources.App__open_databank_close_dialog.open_databank_close_dialog._load** (nested_function, lines 412–476, 65 lines, risk `support`): Handles load for the data bank feature.
- **wave72_databank_sources.App__open_databank_close_dialog.open_databank_close_dialog._close_day** (nested_function, lines 478–537, 60 lines, risk `authentication`): Handles close day for the data bank feature.
- **wave72_databank_sources.App__open_databank_close_dialog.open_databank_close_dialog._reopen_day** (nested_function, lines 539–566, 28 lines, risk `authentication`): Handles reopen day for the data bank feature.
- **wave72_databank_sources.App__open_databank_close_dialog.open_databank_close_dialog._update_workflow** (nested_function, lines 568–597, 30 lines, risk `authentication`): Updates update workflow for the data bank feature.
- **wave72_databank_sources.App__open_databank_close_dialog.open_databank_close_dialog._print_report** (nested_function, lines 599–606, 8 lines, risk `reports`): Generates print report for the reports feature.
- **wave72_databank_sources.App__open_databank_close_dialog.open_databank_close_dialog._save_route_copy_now** (nested_function, lines 608–631, 24 lines, risk `support`): Saves save route copy now for the collectors feature.
- **wave72_databank_sources.App__open_databank_close_dialog.open_databank_close_dialog._open_records_list** (nested_function, lines 633–634, 2 lines, risk `support`): Handles open records list for the data bank feature.

## `wave72_databank_sources/App__print_databank_close_report.py`

- **wave72_databank_sources.App__print_databank_close_report.print_databank_close_report** (function, lines 1–235, 235 lines, risk `filesystem`): Generates print databank close report for the data bank feature.

## `wave72_databank_sources/global___spina_auto_close_one_day.py`

- **wave72_databank_sources.global___spina_auto_close_one_day._spina_auto_close_one_day** (function, lines 1–43, 43 lines, risk `support`): Close one Data Bank day using system expected totals as the safe automatic actual amount.

## `wave72_databank_sources/global___spina_perf_refresh_data_grid.py`

- **wave72_databank_sources.global___spina_perf_refresh_data_grid._spina_perf_refresh_data_grid** (function, lines 1–205, 205 lines, risk `ui_only`): Fast Data Bank month grid refresh using bulk month transaction query.
- **wave72_databank_sources.global___spina_perf_refresh_data_grid._spina_perf_refresh_data_grid._yview** (nested_function, lines 49–53, 5 lines, risk `support`): Handles yview for the data bank feature.
- **wave72_databank_sources.global___spina_perf_refresh_data_grid._spina_perf_refresh_data_grid._sync_selection** (nested_function, lines 64–76, 13 lines, risk `ui_only`): Handles sync selection for the data bank feature.

## `wave72_databank_sources/global___spina_run_auto_daily_close.py`

- **wave72_databank_sources.global___spina_run_auto_daily_close._spina_run_auto_daily_close** (function, lines 1–79, 79 lines, risk `support`): Auto-close Data Bank dates that are older than the configured delay.

## `wave72_databank_sources/global___spina_save_closed_collector_route_copy.py`

- **wave72_databank_sources.global___spina_save_closed_collector_route_copy._spina_save_closed_collector_route_copy** (function, lines 1–281, 281 lines, risk `backup`): Save an audit copy of the Collector Route after Daily Close. The PDF contains the closed total/actual cash for the day and the amount paid by each client on that date. It is separate from Generate Report and from editable Data Bank rows.
- **wave72_databank_sources.global___spina_save_closed_collector_route_copy._spina_save_closed_collector_route_copy._rec_get** (nested_function, lines 30–37, 8 lines, risk `support`): Handles rec get for the collectors feature.
- **wave72_databank_sources.global___spina_save_closed_collector_route_copy._spina_save_closed_collector_route_copy._new_page** (nested_function, lines 112–116, 5 lines, risk `support`): Handles new page for the collectors feature.
- **wave72_databank_sources.global___spina_save_closed_collector_route_copy._spina_save_closed_collector_route_copy._ensure** (nested_function, lines 118–120, 3 lines, risk `support`): Handles ensure for the collectors feature.
- **wave72_databank_sources.global___spina_save_closed_collector_route_copy._spina_save_closed_collector_route_copy._draw_header** (nested_function, lines 122–152, 31 lines, risk `support`): Handles draw header for the collectors feature.
- **wave72_databank_sources.global___spina_save_closed_collector_route_copy._spina_save_closed_collector_route_copy._draw_table_header** (nested_function, lines 154–169, 16 lines, risk `backup`): Handles draw table header for the collectors feature.

## `wave72_databank_sources/global__import_from_excel_with_reasons.py`

- **wave72_databank_sources.global__import_from_excel_with_reasons.import_from_excel_with_reasons** (function, lines 1–149, 149 lines, risk `support`): Import the Excel 'range template' where columns are: Client Name | 2025-10-01 | 2025-10-01 Reason | 2025-10-02 | 2025-10-02 Reason | ... Saves both Amount and Reason for each date.
- **wave72_databank_sources.global__import_from_excel_with_reasons.import_from_excel_with_reasons._write** (nested_function, lines 82–149, 68 lines, risk `database_write`): Handles write for the data bank feature.
