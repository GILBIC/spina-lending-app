        ...
        return CollectorRouteRecord(
            ...
            entries=(
                CollectorRouteEntryRecord(
                    ...
                    contract_balance_reconciled=True,
                    contract_schedule_ready=True,
                    ...
                    contract_today_already_covered=True,
    ...
    assert data["entries"] == [
        {
            ...
            "contract_collection_ready": False,
            "contract_days_past_due": 0,
            "contract_today_scheduled_amount": "200.00",
            "contract_today_unpaid_amount": "0.00",
            "contract_today_already_covered": True,
            "contract_next_unpaid_date": "2026-08-08",
            "contract_next_unpaid_amount": "200.00",
            "contract_readiness_message": (
                "Contract schedule is verified and reconciled; contractual mobile "
                "allocation is not enabled yet. Today's scheduled payment: ₱200.00. "
                "Today is already covered by advance. Next unpaid installment: "
                "2026-08-08 – ₱200.00. Contract DPD: 0."
            ),
            "processed_today": True,
            "today_entry_type": "advance",
            "today_collector_name": "Collector One",
