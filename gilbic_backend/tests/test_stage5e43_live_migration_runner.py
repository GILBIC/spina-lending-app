...
def test_workflow_only_runs_stage5e43_live_migration_on_main_push() -> None:
    assert "One-time Stage 5E.4.3 live verified contract registration migration" in WORKFLOW
    assert "github.event_name == 'push'" in WORKFLOW
    assert "tools/stage5e43-live-migration.once" in WORKFLOW
    assert "tools\\apply_stage5e43_migration.py" in WORKFLOW
