...
def component_values(**changes):
    result = {
        ...
        "dst_upfront": "10.00",
        "grt_in_repayments": "0.00",
        "renewal_offset": "0.00",
        "other_upfront_deductions": "0.00",
        "other_scheduled_charges": "0.00",
        "total_upfront_deductions": "10.00",
        "net_proceeds": "990.00",
...
def disclosure_values(**changes):
    result = {
        ...
        "amount_financed_reference": None,
        "finance_charge_total": None,
        "finance_charge_reference": None,
        "non_finance_charge_total": None,
        "non_finance_charge_reference": None,
        "effective_interest_rate": None,
        "effective_interest_rate_reference": None,
        "rate_period": None,
...
def projection_references():
    return {
        "loan_version_reference": "SYN-TERMS-1",
