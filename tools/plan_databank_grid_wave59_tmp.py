...
OUT = ROOT / "artifacts" / "wave-59-databank-grid-candidates.json"
SOURCE_DIR = ROOT / "artifacts" / "wave-59-databank-grid-sources"
TARGET_CLASS = "App"
TARGETS = (
    "goto_current_month",
    "prev_month",
...
PROTECTED_MARKERS = (
    ...
    "write_text", "write_bytes", "unlink", "remove(", "save_cell",
...
def main() -> None:
    ...
    if missing:
        raise SystemExit(f"Missing Wave 59 Data Bank candidates: {missing}")
    ...
    summary = {
        ...
        "all_clean": all(report["classification"] == "presentation_candidate" for report in reports),
        "candidates": reports,
    }
